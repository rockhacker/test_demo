...
class TradeHandleWorker extends Command
{
     ...
     * @var string
     */
    protected $signature = 'UStandardHandle:worker {worker_command} {--mode=}';
    ...
    public function handle()
    {
        ...
        $this->worker->name = 'UStandardHandle:worker';//

        $this->worker->onWorkerStart = [$this, 'onWorkerStart'];

        //设置pid路径
        $path = storage_path('UStandardHandle/');
    ...
    public function onWorkerStart()
    {
        ...
        while (true){
            ...
            LeverUStandard::tradeHandle($currency_match);
//            $this->info('[' .date('Y-m-d H:i:s') . '] symbol '  . $currency_match->symbol);
