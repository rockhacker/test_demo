...
class LeverTransactionController extends Controller
{
    ...
    public function close(Request $request)
    {
        ...
        if(request()->method() == "POST") {
            ...
            $close_price = $request->get('update_price',0);
            ...
            try {
                ...
                $log_type = LeverTransaction::CLOSED_BY_STOP_LOSS;

                if($lever_transaction->profits >= 0){

                    $log_type = LeverTransaction::CLOSED_BY_TARGET_PROFIT;
                }

                $return = LeverTransaction::leverClose($lever_transaction, $log_type,$close_price);
                if (!$return) {
            ...
            return view('admin.leverdeals.close',['id' => $id]);
        }
    ...
    public function dealClosing(Request $request): JsonResponse
    {
        ...
        try {
            ...
            if (empty($lever_transaction)) {
             ...
             if ($lever_transaction->status != LeverTransaction::STATUS_CLOSING) {
