...
return [
    ...
    */
    ...
    'otc' => [
        '商家otc挂单不存在' => '商家otc挂单不存在',
        '交易数量不能小于' => '交易数量不能小于:min_number',
        '商家不存在' => '商家不存在',
        '您不能和自己交易' => '您不能和自己交易',
        '商家挂单交易状态异常' => '商家挂单交易状态异常',
        '商家挂单可交易数量为空'=>'商家挂单可交易数量为空',
        '商家挂单可交易数量不足,当前剩余'=>'商家挂单可交易数量不足,当前剩余',
        '商家发布挂单价格有变化,请刷新后重试'=>'商家发布挂单价格有变化,请刷新后重试',
        '请先设置收付款信息'=>'请先设置收付款信息',
        '您的收付款信息与商家挂单不匹配,无法交易'=>'您的收付款信息与商家挂单不匹配,无法交易',
        '您与该商家有交易未完成,请先完成再操作'=>'您与该商家有交易未完成,请先完成再操作',
        '交易数量只能是'=>'交易数量只能是',
        '交易数量不能超过'=>'交易数量不能超过:max_number'
    ],
