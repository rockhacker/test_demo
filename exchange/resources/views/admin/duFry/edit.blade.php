            ...
            <form class="layui-form" lay-filter="layuiadmin-form-useradmin" id="layuiadmin-form-useradmin">
                ...
                <div class="layui-form-item">
                    ...
                    <div style="margin-left: 30px;">
                        <input type="text" name="other_address" readonly="readonly" lay-verify="other_address" placeholder="请输入名称"
                ...
                <div class="layui-form-item">
                    ...
                    <div style="margin-left: 30px;" >
                        <input type="text" name="get_address" lay-verify="get_address" placeholder="请输入地址"
                ...
                <div class="layui-form-item">
                    ...
                    <div style="margin-left: 30px;">
                        <input type="text" name="type" readonly="readonly" lay-verify="type" placeholder="请输入类型"
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button type="submit" class="layui-btn" lay-submit lay-filter="edit">确认提款</button>
                        <button type="submit" class="layui-btn layui-btn-danger" lay-submit lay-filter="cancel">取消提款</button>
                    </div>
...
<script>
    layui.config({
        ...
        form.on('submit(edit)', function (data) {
            ...
            $.post('/admin/du_fry/update', data.field, function (res) {
        ...
        form.on('submit(cancel)', function (data) {
            $.post('/admin/du_fry/cancel', data.field, function (res) {
                layer.msg(res.msg);
