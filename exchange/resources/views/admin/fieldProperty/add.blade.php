...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-card-header">添加属性组</div>
        <div class="layui-card-body">
            <form class="layui-form" lay-filter="layuiadmin-form-useradmin" id="layuiadmin-form-useradmin">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">适用标签</label>
                    <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea name="apply_to_type" class="layui-textarea" placeholder="多个类型用英文状态 , 号分割 , 没有限制留空"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    layui.config({
        ...
        form.on('submit', function (data) {
            ...
            $.post('/admin/field_property/save', data.field, function (res) {
                layer.msg(res.msg);
            });
            return false;
        })
