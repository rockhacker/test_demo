            ...
            <form class="layui-form" lay-filter="layuiadmin-form-useradmin" id="layuiadmin-form-useradmin">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="currency_name" placeholder="请填写币种名称,如:USD" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="recharge_bili" placeholder="请填写" class="layui-input">
                    </div>
                </div>
...
<script>
    layui.config({
        ...
        form.on('submit', function (data) {
            ...
            $.post('/admin/forex/settle_currency/save', data.field, function (res) {
                layer.msg(res.msg);
                if (res.code) {
                    id = res.data.id
                    setTimeout(function(){
