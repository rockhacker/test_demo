                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <select name="status" id="status">
                            <option value="0">所有</option>
                            <option value="{{\App\Models\Iso\IsoLever::STATUS_WAIT}}">挂单中</option>
                            <option value="{{\App\Models\Iso\IsoLever::STATUS_TX}}">交易中</option>
                            <option value="{{\App\Models\Iso\IsoLever::STATUS_CLOSING}}">平仓中</option>
                            <option value="{{\App\Models\Iso\IsoLever::STATUS_CLOSED}}">已平仓</option>
                            <option value="{{\App\Models\Iso\IsoLever::STATUS_CANCEL}}">已撤单</option>
                        </select>
                    </div>
                </div>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline" style="width:70px;">
                        <select name="type" id="type">
                            <option value="0">所有</option>
                            <option value="{{\App\Models\Iso\IsoLever::TYPE_BUY}}">买入</option>
                            <option value="{{\App\Models\Iso\IsoLever::TYPE_SELL}}">卖出</option>
                        </select>
                    </div>
                </div>
            </div>
    ...
    layui.use(['element', 'form', 'layer', 'table', 'laydate'], function () {
        ...
        var lever_list = table.render({
            ...
            , cols: [[
                ...
                , {field: 'origin_price', title: '原始价', width: 100, hide: true}
                , {field: 'fact_price', title: '开仓价', width: 100}
                , {field: 'share', title: '手数', width: 90}
                , {field: 'multiple', title: '倍数', sort: true, width: 90, hide: true}
                , {field: 'origin_caution_money', title: '初始保证金', width: 100, hide: true}
                ...
                , {field: 'now_profits', title: '盈亏', width: 100, totalRow: true}
                , {field: 'boom_price', title: '强平价', width: 100}
                , {field: 'created_at', title: '创建时间', width: 170}
                , {field: 'updated_at', title: '刷新时间', sort: true, width: 170, hide: true}
                , {field: 'closed_at', title: '平仓时间', sort: true, width: 170}
