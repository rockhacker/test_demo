...
<script type="text/html" id="status_name">
    @{{# if (d.status == 1) { }}
    <span style="color:#89deb3;">正在运行</span>
    @{{# } else if (d.status == 2) { }}
...
<script type="text/html" id="symbol_name">
    <span>@{{d.currency_match.symbol}}</span>
</script>
    ...
    window.onload = function () {
        ...
        layui.config({
            ...
            var data_table = table.render({
                elem: '#order_list',
                url: "/admin/option_periods_index",
                ...
                totalRow: true,
                cols: [[
                    {field: 'period', title: '期数', width: 100}
                    ,{field: 'symbol_name', title: '交易对', width: 140, sort: true, templet: '#symbol_name'}
                    ,{field: 'seconds_id', title: '秒数', width: 110, sort: true, templet: '#second_num'}
                    ...
                    ,{field: 'close_price', title: '平仓价', width: 100}
                    ,{field: 'created_time', title: '创建时间', width: 170, sort: true}
                    ,{field: 'start_time', title: '开始时间', width: 170, sort: true,}
                    ,{field: 'result_time', title: '结束时间', width: 170, sort: true,}
