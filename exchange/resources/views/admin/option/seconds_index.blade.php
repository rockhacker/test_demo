...
<div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            <button class="layui-btn" lay-href="/admin/option_seconds_add">添加设置</button>
        </div>
...
<script>
    layui.config({
        ...
        table.render({
            elem: '#list'
            , url: '/admin/option_seconds_list' //数据接口
            , page: true //开启分页
            , height: 'full-100'
            , cols: [[ //表头
        ...
        form.on('switch(status)', function (obj) {
            var id = this.value;
            $.ajax({
                url: '/admin/option_seconds_status',
                type: 'post',
                dataType: 'json',
                data: {id: id},
        ...
        table.on('tool(list)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                layer.open({
                    ...
                    title: '修改',
                    area: ['800px', '600px'],
                    content: '/admin/option_seconds_add?id=' + data.id,
                    end: function () {
                        table.reload('list');
                    }
                });
