                        ...
                        <div class="layui-timeline-content layui-text">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" placeholder="请填写项目标题" class="layui-input" value="{{$project->title}}">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <input type="hidden" id="upload-input" name="banner" value="{{$project->banner}}">
                                    <div style="margin-top: 10px">
                                        <img width="200px" id="upload-img" src="{{$project->banner}}">
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea class="layui-textarea" name="introduction" cols="30" rows="10">{{$project->introduction}}</textarea>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="layui-timeline-content layui-text">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" class="layui-input" name="min_buy_number" value="{{$project->min_buy_number}}"
                                           placeholder="最小数量" >
                                </div>
                                <div class="layui-form-mid">-</div>
                                <div class="layui-input-inline">
                                    <input type="number" class="layui-input" name="max_buy_number" value="{{$project->max_buy_number}}"
                                           placeholder="最大数量">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="number" class="layui-input" name="project_number" value="{{$project->project_number}}"
                                           placeholder="总认购数量">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea name="detail_introduction" id="detail_introduction_editor"
                                              style="display: none;">{{$project->detail_introduction}}</textarea>
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea name="participation_conditions" id="participation_conditions_editor"
                                              style="display: none;">{{$project->participation_conditions}}</textarea>
                                </div>
                            </div>
                        </div>
                    </li>
...
<script>
    layui.config({
        ...
        form.on('submit', function (data) {
            ...
            $.post('/admin/project/edit_project_post', data.field, function (res) {
                layer.msg(res.msg);
                if (res.code) {
                    id = res.data.id
                    setTimeout(function () {
