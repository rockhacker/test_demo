        ...
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            <div class="layui-form-item">
                <div class="layui-inline">
                    <button class="layui-btn" lay-href="/admin/quickCharge/add">添加充值地址</button>
                </div>
            </div>
        </div>
    ...
    layui.config({
        ...
        table.on('tool(data_table)', function (obj) {
            ...
            if (layEvent === 'del') {
                ...
                $.post('/admin/quickCharge/del?id='+data.id, data.field, function (res) {
                    layer.msg(res.msg);
                    if (res.code) {
