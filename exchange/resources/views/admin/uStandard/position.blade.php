    ...
    window.onload = function() {
        ...
        layui.use(['element', 'form', 'layer', 'table', 'laydate'], function () {
            ...
            var lever_list = table.render({
                elem: '#leverList'
                ,url: '/admin/u_standard/list?is_position=1'
                ,height: 'full-80'
                ,page: true
                ,limit: 20
                ,toolbar: true
                ...
                ,cols: [[
                    ...
                    ,{field: 'profit_bi', title: '盈亏比', width: 100}
                    ...
                    ,{field: 'explode', title: '爆仓价', width: 140}
            ...
            table.on('tool(leverList)', function (obj) { //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if (layEvent === 'close') { //删除
                    ...
                    layer.confirm('确定结算该订单吗？', function (index) {
                        //向服务端发送删除指令
                        $.ajax({
                            url: "/admin/u_standard/dealClosing",
                            type: 'post',
                            dataType: 'json',
                            data: {id: data.id},
                            success: function (res) {
