        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                ...
                <script type="text/html" id="table-tool">
                    ...
                    <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="addsonagent"><i class="layui-icon layui-icon-add-1"></i>添加下级代理</a>
                    <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="getsons"><i class="layui-icon layui-icon-friends"></i>查看下级代理</a>
