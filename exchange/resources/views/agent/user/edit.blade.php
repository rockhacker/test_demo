            ...
            <form class="layui-form" lay-filter="layuiadmin-form-useradmin" id="layuiadmin-form-useradmin">
                ...
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>盈利概率</td>
                        <td>
                            <input type="text" name="micro_risk_profit_probability" class="layui-input"
                                   value="{{$user->micro_risk_profit_probability}}" placeholder="盈利概率(1为百分之1)">
                        </td>
                    </tr>
                    <tr>
                        <td>信用分</td>
                        <td>
                            <input type="text" name="credit_score" class="layui-input" value="{{$user->credit_score}}"
                                   placeholder="信用分">
                        </td>
                    </tr>
                    {{--                    <tr>--}}
...
<script>
    layui.config({
        ...
        form.on('submit', function (data) {
            ...
            $.post('/agent/user/update', data.field, function (res) {
                layer.msg(res.msg);
