        ...
        layui.use(['index', 'element', 'form', 'table', 'layer', 'laydate'], function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {field: 'uid', width: 160, title: 'UID'}
                    , {field: 'mobile', title: '手机号', minWidth: 150, style: "color: #fff;background-color: #5FB878;"}
                    , {field: 'email', title: '邮箱', minWidth: 150, style: "color: #fff;background-color: #5FB878;"}
