    ...
    Route::middleware(['agent_auth'])->group(
        function () {
            ...
            Route::prefix('order')->group(function () {
                ...
                Route::get('micro_order_edit', 'OrderController@micro_order_edit');//
                Route::post('micro_order_rick', 'OrderController@micro_order_rick');//提交风控
                Route::post('micro_order_all_rick', 'OrderController@micro_order_all_rick');//提交风控
            ...
            Route::prefix('forex')->group(function (){
                Route::get('index','ForexController@index');
                Route::get('list','ForexController@list');
            });
