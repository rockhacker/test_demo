				...
				<view class="w-full flex flex-col p-40 border-0 border-solid border-b-2 border-gray-100 dark:border-gray-900">
					<view class="w-full flex justify-center">
						<view class="flex w-500 h-60 bg-gray-100 dark:bg-gray-600 dark:bg-opacity-30 rounded-2xl overflow-hidden">
							<view class="flex-1 flex justify-center items-center text-center" :class="active==0?'bg-main-linear  text-white':''" @tap="setActive(0)">{{$t('new.leverLes')}}</view>
							<view class="flex-1 flex justify-center items-center text-center" :class="active==1?'bg-main-linear  text-white':''" @click="setActive(1)">{{$t('new.leverAll')}}</view>
							<!-- <view class="flex-1 flex justify-center items-center text-center" :class="active==2?'bg-primary text-white':''" @tap="setActive(2)">{{$t('qqjy.qqjy')}}</view> -->
						</view>
					</view>
						...
						<view class="mt-20 text-lg">
							...
							<view class="flex justify-between items-center my-20 border-2 border-solid border-gray-400 dark:border-gray-600 px-20 rounded-8">
								<view class="flex-1 h-60 flex items-center">
									<input class="text-black dark:text-white text-sm" placeholder-class="text-gray-600 flex-1" type="digit" v-model="leverOrder.share" :placeholder="$t('trade.p_handnum')" />
								</view>
