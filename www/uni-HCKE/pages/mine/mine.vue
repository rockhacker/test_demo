	...
	<uni-nav-bar>
		<view class="w-full bg-my-grey dark:bg-my-black">
			...
			<view class="mt-20 w-full px-20 pb-20">
				<view class="bg-main-linear rounded-lg p-40">
					...
					<view class="text-clip-yellow dark:text-white text-lg my-20">{{ active==1 && token?(all?all.toFixed(2):all):'******' }} </view>
					<navigator url="/pages/assets/assets" class="flex justify-between items-center">
						<view class="text-0AA6AC rounded-3xl px-20 py-10" :class="[theme=='dark'?'dark:bg-white':'bg-yellow-liner']">
