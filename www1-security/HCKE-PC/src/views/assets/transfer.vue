  ...
  <div class="baselight">
    ...
    <div class="plr20 pt20 pb50 cointransfer">
      <div class="flex alcenter">
        ...
        <el-select v-model="curcoin" class="flex1 bdinput" @change="changeCoin" placeholder="">
          <el-option
        ...
        <div class="flex">
          <div style="position: relative;">
            <div class="flex alcenter" style="position: relative;">
              <div class="pr10" style="position: absolute;left:10px">{{$t('assets.from')}}</div>
              <el-select v-model="fromtype" class="bdinput" @change="changetransfer1" placeholder="">
                <el-option
          ...
          <div class="pl10" style="position: relative;">
            <div class="flex alcenter" style="position: relative;">
              <div class="pr10" style="position: absolute;left:10px">{{$t('assets.reach')}}</div>
              <el-select v-model="totype" class="bdinput" @change="changetransfer2" placeholder="">
                <el-option
                  v-for="item in accoutlist"
                  :key="item.account_code"
                  :label="item.name"
