		...
		<div class="mauto wt1200 ptb20">
			...
			<el-card class="box-card mb20">
				<el-breadcrumb separator="/">
				  ...
				  <el-breadcrumb-item :to="{ path: '/stakingOrders' }">{{$t('staking.shengouliebiao')}}</el-breadcrumb-item>
				  <el-breadcrumb-item>{{$t('staking.shouyiliebiao')}}</el-breadcrumb-item>
				</el-breadcrumb>
			</el-card>
			<el-card class="box-card mb20">
				<div class="ft18 mt10 mb20">{{$t('staking.shouyiliebiao')}}</div>
				<el-table :data="tableData" :empty-text="$t('staking.noRecords')" style="width: 100%">
