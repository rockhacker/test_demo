<template>
	<div class="minh100 ft16">
		<div class="bgwhite">
			<div class="mauto wt1200 ptb20">
				<div class="flex between">
					<div class="flex1">
						<div class="ft40 bold black">{{$t('staking.kuanjishangcheng')}}</div>
		...
		<div class="mauto pt20 wt1200 pb80">
			<el-card class="ft18 mb20">
				{{$t('staking.chanpinliebiao')}}
				<el-link style="float: right; padding: 3px 0" type="warning" @click="$router.push({path:'/stakingOrders'})">{{$t('staking.shengouliebiao')}}</el-link>
			</el-card>
			<el-card class="box-card mb20" v-for="item,index in stakingData" :key="index">
