<template xlang="wxml">
	<view :class="theme" class="h-full">
		<view class="bg-white dark:bg-floor flex flex-col items-center justify-center h-full" >
			...
			<view class="w-full p-40">
				<view class="bg-gray-100 rounded-xl flex justify-between items-center p-30 box-border text-primary">
					<input type="text" :value="val" class="flex-1 text-black" disabled/>
					<view class="text-warn px-20" @click="copyText(val,'复制成功')">复制</view>
				</view>
			</view>
