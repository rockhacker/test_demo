...
export const useOtcOrder = () => {
    ...
    const cancelOrder = async () => {
        await showConfirmDialog({
            title: t('legal.confirm_cancel_order'),
            message: t('legal.cancel_rules'),
        })

        const { msg } = await cancelOtcOrder({ detail_id: id })
    ...
    const payOrder = async () => {
        await showConfirmDialog({
            title: t('legal.confirm_has_pay'),
            message: t('legal.confirm_pay_tip'),
        })

        const { msg } = await confirmPayOtcOrder({ detail_id: id, pay_voucher: pay_voucher.value })
    ...
    const delayOrder = async () => {
        await showConfirmDialog({
            title: t('legal.delay_confirm'),
            message: t('legal.confirm_pay_tip'),
        })

        const { msg } = await delayConfirmOtcOrder({ detail_id: id })
    ...
    const arbitrateOrder = async () => {
        await showConfirmDialog({
            title: t('legal.apply_protection'),
            message: t('legal.confirm_pay_tip'),
        })

        const { msg } = await arbitrateOtcOrder({ detail_id: id })
    ...
    const confirmOrder = async () => {
        await showConfirmDialog({
            title: t('legal.confirm_pay'),
            message: t('legal.confirm_pay_tip'),
        })

        const { msg } = await confirmOtcOrder({ detail_id: id })
