<template>
    <div class="z-99">
        ...
        <div class="depth">
            <van-skeleton class="w-full" :loading="(!sellList.length || !buyList.length) && match.MarketStatus === 1">
                <template #template>
                    <van-skeleton-paragraph class="h-20 mt-2" v-for="item in new Array(5)" />
                    <van-skeleton-paragraph class="h-20 mt-2" v-for="item in new Array(5)" />
                </template>
                <template v-if="match.MarketStatus === 1">
                    <div class=" text-12">
