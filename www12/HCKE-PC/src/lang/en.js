export default {
	...
	new: {
		yhkcz:"Bank card recharge",
		lxxskf:"Please contact online customer service",
		ykb: "Profit loss ratio",
		lock: "Locked, please contact customer service",
		"profitRate":"Profit rate",
    ...
    zhang: "a sheet",
		...
		hdjs:'Activity description',
		wait_handle: "Please wait patiently for the merchant to handle it for you",
		selluser: "Seller account", 
		buyuser: "Buyer account",
		fybl: "An example of his servant",
    yj: "class a",
    ej: "second level",
    sj: "Level III",
    yqrssl: "Number of invitees",
    zhjlsl: "Total commission",
    khyx: "Other domestic users",
    jl: "Other commission amount",
    wdtg: "My promotion",
		"lxkf":"Please contact customer service to obtain a currency merchant bank account",
		"tqsh":"For early redemption, please contact customer service",
		"ysqhq": "Derivatives market",
		...
		zhidaoshouce: 'DEMO new User Guide - Account Registration and top-up',
	...
	subscription:{
		new_subscription: 'IEO Subscription',
