<template>
  <div class="home">
    ...
    <div class="pb40" v-if="marketlist.length">
      ...
      <div class="flex mt30">
        ...
        <div class="flex bg-new-blue between white alcenter plr10 ptb10 mb20 pointer"  @click="toUrl(list.matches[0])">
          ...
          <div class="flex ht30 alcenter white">
        ...
        <!-- <div class="flex1"></div> -->
           ...
           <div class="flex ptb20 pointer white" v-for="(item,index) in list.matches.length<4?list.matches:list.matches.slice(0,4)" :key="index"  @click="toUrl(item)">
    ...
    <div class="pt30 pb30">
       ...
       <div>
	    ...
	    <div class="content mauto mt30 white" style="width:900px" v-html="$t('new.jiec')"></div>
