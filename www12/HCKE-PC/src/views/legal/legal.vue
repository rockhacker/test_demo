<template>
    <div>
        <div class="w100 mauto baselight2 mt20 bgwhite dark-bg-1C2532 ptb10 flex alcenter between ft16 plr20 radius2">
            <p class="text-clip-green ptb10">{{$t('legal.trade')}}</p>
            <p class="ptb10 pointer" @click="goOrder">{{$t('legal.order')}}</p>
        </div>
        <div class="ht10 bgline"></div>
        <div class="radius2">
            <div class="bgwhite dark-bg-1C2532 plr20 radius2">
            ...
            <div class="plr20 mt20 baselight2">
                ...
                <div class="flex alcenter ptb10 bdb30" v-for="(item,i) in orderlist" :key='i'>
                    ...
                    <div class="wt50 bg-main-liner tc white radius2 ptb5 pointer" @click="getinfo(item)">{{selectType=='BUY'?$t('legal.buy'):$t('legal.sell')}}</div>
                </div>
            </div>
            ...
            <el-dialog
                ...
                <div class="">
                    ...
                    <div>
                        ...
                        <p class="mb15" v-if="coinlist[coinIndex] && selectType!='BUY'">{{$t('legal.limit')}}：{{Data.min_number}}-{{Data.max_number}}  {{coinlist[coinIndex].code}}</p>
                        <p v-if="coinlist[coinIndex]">{{$t('legal.allmoney')}}：{{totalPrice }} {{coinlist[coinIndex].code}}</p>
                    </div>
                </div>
