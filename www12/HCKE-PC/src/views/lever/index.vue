      ...
      <div class="wt240 bd mr5 bgwhite dark-bg-1C2532 ptb10 radius2 h0">
        <div class="flex alcenter plr10">
          <div
            ...
            :class="{ 'bg-main-liner black': currentIndex == i }"
          ...
          <div v-if="list.length > 0 && list[currentIndex]">
            ...
            >
              ...
              <div class="flex1 tr baselight2" v-if="itm.currency_quotation">
                <!-- {{ itm.base_currency_code=='ETHFX'?!isOnline(itm.market_time)?$t('trade.soon'):itm.currency_quotation.close:itm.currency_quotation.close }} -->
              ...
              <div
                ...
                v-if="(itm.base_currency_code=='ETHFX'?isOnline(itm.market_time):true) && itm.currency_quotation"
              >
