...
<div class="bgpart">
    <div class="recharge">
       ...
       <!-- <div class="recharge-header f-item baselight2">
        ...
        <div class="recharge-content f-item baselight2">
            ...
            <div class="items">
                <div class="item" v-for="(item,index) in wallet_data" :key="index">
                   ...
                   <div class="ft16 flex">
                        <div
                        class="plr10 ptb5 bg-main-liner black radius6 tc"
                        @click="detail(item)"
        ...
        <div class="recharge-content f-item baselight2 pointer" style="margin-top: 20px;" @click="showMsg">
            <div class="items">
                <div class="item" >
                   <div class="left">
                      <span class="text">{{$t('new.yhkcz')}}</span>
                   </div> 
                </div>
            </div>
        </div>
