	...
	<div class="rechargeOpen " >
         <div class="open-header f-item">
            ...
            ></vue-qr>
              ...
              <button class="qr-btn bg-main-liner black" @click="setCopy">{{$t('feed.copyadd')}}</button>
         </div>
         <div class="open-form">
        ...
        <div class="footer">
            <button v-loading="loading" class="sub-btn bg-main-liner black" @click="submit">{{$t('feed.submit_transaction_screenshot')}}</button>
        </div>
