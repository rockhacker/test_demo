<template>
    <div class="flex alcenter jscenter bg-main-liner minvh100 register-page">
        <div class="bgwhite radius4 plr60 ptb40 w25 mwidth" style="margin-top:60px;">
            <div class="tc ft20 text-333333">{{$t('register.welcome')}}</div>
            <div class="mt40 ">
                ...
                <div class="mt20 border-b-EEEEEE ht50 lh50 flex alcenter">
                    ...
                    <input type="text" class="flex1 h100  pl20 black" v-model="account" @change="changeAccount" :placeholder="index == 0 ? $t('register.enterPhone') : $t('register.enterEmail')">
                </div>
                <!-- <p class="mt20">
                ...
                <div class="mt20 border-b-EEEEEE ht50 lh50 flex alcenter">
                     <el-select  filterable v-model="country_code"  class="w25" @change='changeCountry'>
                        <el-option
                            v-for="item in countries"
                            :key="item.id"
                            :label="item.global_code"
                    ...
                    <input type="text" class="flex1 h100  pl20 black" v-model="mobile"  :placeholder="$t('register.enterPhone')">
                </div>
                <div class="mt20 border-b-EEEEEE ht50 lh50 flex alcenter">
                ...
                <div class="mt40 bg-main-liner black tc h48 lh48 radius2 pointer" @click='register'>{{$t('register.register')}}</div>
            </div>
        </div>
    </div>
</template>
...
export default {
        ...
        .then(res=>{
           ...
           if(res.length>0){
            //    this.country_code='+'+res[0].global_code;
                 this.country_code = `001`;
                 this.countryCodeId = 2;
           }
        })
        // this.country_code = "";
    ...
    computed:{
        getCountryCode(){
            return this.countryCodeId ? this.countries.find((item)=> item.id == this.countryCodeId).global_code : '';
        }
    },
    methods:{
         //   上传图片
      ...
      //   });
        ...
        register(){
            ...
            var data={
                ...
                mobile: this.mobile? `${this.getCountryCode}-${this.mobile}` : ''
            }
            console.log(data);
