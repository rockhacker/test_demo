	...
	<div class="minh100 ft16">
		<div class="mauto wt1200 ptb20">
			...
			<el-card class="box-card mb20 dark-bg-1C2532">
				...
				<el-table :highlight-current-row="false" :data="tableData" :empty-text="$t('staking.noRecords')" style="width: 100%" header-cell-class-name="dark-bg-1C2532"  cell-class-name="dark-bg-1C2532">
			...
			try {
				...
				that.$confirm(that.$t('new.tqsh'), that.$t('staking.hint'), {
				        //   confirmButtonText: that.$t('staking.tqsh'),
						  ...
						  confirmButtonClass:'bg-main-liner black',
						  cancelButtonClass:'bg-main-liner black'
				        }).then(() => {
