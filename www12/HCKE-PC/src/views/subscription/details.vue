		...
		<div class="mauto wt1200 ptb20">
			...
			<el-card class="box-card mb20 ft20 dark-bg-1C2532 dark-text-white">
				<div class="ft18 mlr20 mtb20 plr70 ptb30 radius10">
					...
					<el-button class="w100 mb50 bg-main-liner black" @click="submit">{{$t('subscription.lijishenggou')}}</el-button>
					<div class="flex end" v-if="subscription.link">
						 <el-button class="w-100 mb50 bg-main-liner black" @click="baipi">{{$t('new.baipi')}}</el-button>
					</div>
...
<script>
	...
	export default{
		...
		methods:{
			baipi(){
				window.open(this.subscription.link)
			},
			// 产品详情
			getDetails() {
				try {
