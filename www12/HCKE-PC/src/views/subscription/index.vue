		...
		<div class="mauto wt1200 ptb20">
			...
			<el-card class="box-card mb20 dark-bg-1C2532" @click="$router.push({path:'/subscriptionDetails?id=0'})" hover-class="opacity-50" v-for="(item,index) in list" :key="index">
				<div class="flex between">
					...
					<el-button class="wt100 mr10 bg-main-liner black" style="border-radius: 0;" @click="$router.push({path:`/subscriptionDetails?id=${item.id}`})">{{$t('subscription.canjiahuodong')}}</el-button>
				</div>
				...
				<div class="w100 ht30 radius40 bgf6 posRelt overxy">
					<div class="abstort lf0 h100 lh30 bg-main-liner black ft14 tr" :style="`width: ${remainingRatio(item.subscribed,item.issue_number)}%;`">
