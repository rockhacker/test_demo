    ...
    <div>
        <div class="bgwhite dark-bg-1C2532 plr15 pt10 baselight2 flex alcenter between ptb10">
            <div class='flex alcenter'>
                <p class='ft16 mr30 pointer' :class="{'text-2FA079':curdelegate==0}"  @click='changedelegate(0)'>{{$t('trade.delegate')}}</p>
                <p class='ft16 mr30 pointer' :class="{'text-2FA079':curdelegate==1}" @click='changedelegate(1)'>{{$t('trade.all_delegate')}}</p>
                <p class='ft16 mr30 pointer' :class="{'text-2FA079':curdelegate==2}" @click='changedelegate(2)'>{{$t('trade.his_delegate')}}</p>
            </div>
