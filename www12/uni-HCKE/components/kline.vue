<template>
  <div>
    <div class="divchart bg-white dark:bg-main-black">
    <div>
...
export default {
  ...
  methods: {
    ...
    SetHQChartStyle(blackStyle) {
      blackStyle.BGColor =  this.theme =='dark'?"#16171C":"#fff"; //背景
      blackStyle.TooltipPaint.BGColor = "rgba(14,24,46,0.8)"; //tooltip背景色
      blackStyle.FrameTitleBGColor = this.theme =='dark'?"#16171C":"#fff"; //指标标题背景
