<template>
	<view :class="theme">
		<view class="bg-white dark:bg-main-black dark:text-white">
		...
		<view class="mt-20 bg-white dark:bg-main-black p-30 text-center dark:text-white">
			...
			<view class="mt-20 mx-auto w-160 h-60 rounded-10 flex justify-center items-center bg-new-orange text-white" @tap="fuzhi_invite">{{ $t('assets.coypaddr') }}</view>
		</view>
		<view class="bg-white dark:bg-main-black p-30 text-my-black dark:text-white">
			<!-- <view class="mb-10">
