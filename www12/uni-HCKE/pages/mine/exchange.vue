<template>
	<view  :class="theme">
	     <view class="px-30 bg-main-black 
          min-h-screen dark:text-white">
               ...
               <button class="w-full rounded-10 bg-new-orange text-black text-xl mt-100" @click="sub">{{$t('new.duih')}}</button>
         </view>
	</view>
</template>
