		...
		<view class="p-40 bg-white dark:bg-floor">
			<view class="flex items-center">
				...
				<view class="flex flex-col justify-center items-center" :class="{ 'text-primary': loginActive == 1 }" @tap="loginActive=1;">
					<view class="mb-30 text-xl text-new-orange">{{$t('login').f_email}}</view>
			...
			<view class="mt-80">
				...
				<view class="my-100 bg-new-orange rounded-10 p-20 text-white text-lg text-center" @tap="goNext" hover-class="opacity-50">{{$t('login').r_next}}</view>
			</view>
		</view>
