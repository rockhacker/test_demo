<template>
  <view :class="theme">
	  <view class="bg-my-grey dark:bg-main-black text-black dark:text-white" style="min-height: 100vh;">
		...
		<view class="p-40">
			<view class="flex items-start justify-between">
				...
				<!-- <view class="flex flex-col justify-center items-center mr-20" :class="{ 'text-new-orange': loginActive == 0 }" @tap="loginActive = 0">
					  <view class="mb-30 text-xl">{{$t('login').l_mobile}}</view>
					  <view class="w-60 h-4 bg-new-orange" v-if="loginActive == 0"></view>
				</view>		 -->
				<view class="flex flex-col justify-center items-center" :class="{ 'text-new-orange': loginActive == 1 }" @tap="loginActive = 1">
					<view class="mb-30 text-xl">{{ $t("login").l_email }}</view>
					<view class="w-60 h-4 bg-new-orange" v-if="loginActive == 1"></view>
				</view>
			</view>
			...
			<view class="py-40">
				...
				<view class="mt-30 flex items-center justify-between">
					...
					<navigator url="forgetPwd" class="text-new-orange">{{$t("login").forget_pwd}}</navigator>
				</view>
				<view class="my-60 bg-new-orange rounded-10 p-20 text-white text-lg text-center" @tap="login" hover-class="opacity-50">{{ $t("login").login }}</view>
				<view class="my-60 bg-new-orange rounded-10 p-20 text-white text-lg text-center mt-30" @tap="toWallet" hover-class="opacity-50">{{ $t("wallet.login") }}</view>

			</view>
			  <view class="flex items-center justify-center">
				<view class="flex items-center">
				  <text>{{ $t("login").noaccount }}</text>
				  <navigator url="register" class="text-new-orange">{{$t("login").register}}</navigator>
				</view>
