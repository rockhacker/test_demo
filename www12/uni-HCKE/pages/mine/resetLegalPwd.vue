<template>
	<view class="min-h-screen"  :class="theme">
		<view class="bg-my-grey dark:bg-main-black p-40 min-h-screen">
			...
			<view class="mt-100 bg-new-orange rounded-10 p-20 text-black text-lg text-center" @tap="register" hover-class="opacity-50">{{ $t('login').e_confrim }}</view>
		</view>
	</view>
</template>
