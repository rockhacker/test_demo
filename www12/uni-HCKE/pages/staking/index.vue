		...
		<view class="text-black dark:text-white dark:bg-101625 dark:bg-opacity-30 w-full min-h-screen">
			<uni-nav-bar fixed backIcon>
				<view class="flex1 flex items-center justify-between">
					<view class="flex-1 p-30 bg-white dark:bg-main-black flex justify-center items-center text-2xl">
			...
			<scroll-view scroll-y class="w-full">
				<view class="p-30 pt-0">
					<view class="justify-between rounded-10 bg-white dark:bg-main-black text-black dark:text-white px-20 py-30 mt-30"
						...
						<view class="mt-20 flex items-center text-center">
							<view class="flex-1">
								<view class="mt-10">{{item.lock_dividend_days}} {{$t('new.day')}}</view>
