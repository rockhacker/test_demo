<template>
  <div class="mymention pb60">
    <div class="flex between baselight2 ptb20 plr20 ft16 bgwhite">
      <span class="basecolor">{{$t('bind.bindAddr')}}</span>
    </div>
    <div class="mt20 plr30">
      <div class="flex alcenter mb20">
        <div class="flex alcenter flex1">
          <span class="wt100 basecolor">{{$t('lever.currency')}}：</span>
          <el-select v-model="currencyCode" class="flex1" @change="changeCurrency" placeholder="">
        ...
        <div class="flex alcenter flex1 ml30" v-if="currencyProtocols.length > 1">
          <span class="wt100 basecolor">{{$t('assets.chainName')}}：</span>
          <el-select v-model="currencyProtocolsCode" class="flex1" @change="changeProtocols" placeholder="">
            <el-option
      ...
      <div class="flex alcenter flex1 mb20">
        <span class="wt100 basecolor">{{$t('bind.addr')}}:</span>
        <input type="text" v-model="address" class="ht40 lh40 plr20 flex1 borGray
        " />
      </div>
      <!-- <div class="flex alcenter flex1 mb20">
      ...
      <div class="mt30 radius2 ft16 tc ht48 lh48 white bg-main w100" @click="bindAddress">{{$t('bind.bind')}}</div>
    </div>
  </div>
</template>
<script>
