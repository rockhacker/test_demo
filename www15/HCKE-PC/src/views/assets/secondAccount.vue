<template>
  <div class="baselight">
    <div class="flex between ptb20 plr20 ft16 bgwhite border-bottom-gray">
      <span class="basecolor">{{$t('assets.allAssets')}}: <span class="text-main">${{changeData.convert_usd}}</span></span>
       <router-link :to="{name:'dealRecords',query:{types:changeData.account_code}}" class="basecolor">{{$t('assets.records')}}</router-link>
    </div>
    <div class="ptb10">
      <div class="flex alcenter basecolor mb10 plr20">
      ...
      <div v-for="(item,i) in coinlist" :key="i">
        <div class="flex alcenter ptb10 plr20 basecolor">
        ...
        <!-- 提币 -->
        <div class="mtb20 mlr20 radius2 bdheader ptb20 plr20" v-show="curindex==i&&infotype=='mention'">
          <div
            class="mb20"
