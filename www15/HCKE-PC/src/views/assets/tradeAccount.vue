<template>
  <div class="baselight tradeAccount">
    <div class="flex between baselight2 ptb20 plr20 ft16 border-bottom-gray">
      <span class="basecolor plr10 ptb5" style="border-left: 3px solid #057967;">{{$t('assets.allAssets')}}:<span class="text-main"> ${{changeData.convert_usd}}</span></span>
      <router-link :to="{name:'dealRecords',query:{types:changeData.account_code}}" class="basecolor">{{$t('assets.records')}}</router-link>
    </div>
    <div class="ptb10">
      <div class="flex alcenter mb10 plr20 basecolor">
      ...
      <div v-for="(item,i) in coinlist" :key="i">
        <div class="flex alcenter ptb10 plr20 gray6">
          ...
          <div class="flex1 tr baselight2" v-if="changeData.is_recharge==1">
            <!-- <el-button class="bg-main white" style="padding: 4px" size="mini" @click="showInfo(item,i,'charge')" :disabled="!(item.currency&&item.currency.open_recharge==1)">{{$t('assets.charge')}}</el-button> -->
            <!-- <span
              class="pointer"
            ...
            <el-button class="bg-main white" style="padding: 4px" size="mini" @click="showInfo(item,i,'mention')" :disabled="!(item.currency&&item.currency.open_draw==1)">{{$t('assets.mention')}}</el-button>
            <!-- <span
              class="pointer"
        ...
        <!-- 充币 -->
        <div class="mlr20 mtb20 radius2 ptb20 plr20 basecolor borGray" v-show="curindex==i&&infotype=='charge'">
          <div
            class="mb20"
          ...
          >
            ...
            <ul class="flex mt10">
              <li
                class="mr20 borGray ptb5 plr15 radius4"
        ...
        <!-- 提币 -->
        <div class="mlr20 mtb20 radius2 borGray ptb20 plr20 gray6" v-show="curindex==i&&infotype=='mention'">
          <div
            class="mb20"
          ...
          <div>
            ...
            <input
              ...
              class="ht40 lh40 plr20 borGray w100 mt10 baselight2"
              disabled
            />
          </div>
          ...
          <div class="mt20">
            ...
            <input
              ...
              class="ht40 lh40 plr20 borGray mt10 w100 baselight2"
            />
          </div>
          <div class="flex mt20">
            <div class="flex1">
              <p>{{$t('assets.fee')}}</p>
              <p class="ht40 lh40 plr20 borGray mt10 w100 baselight2">{{mentionInfo.rate *100}}%</p>
            </div>
          ...
          <div class="mt30 radius2 tc ht48 lh48 white bg-main white" @click="mentionSubmit">{{$t('assets.mention')}}</div>
        </div>
      </div>
    </div>
  </div>
...
.tradeAccount .el-button.is-disabled{
  /* color: #222 !important; */
  background-color: rgba(102, 102, 102, 0.785) !important;
}
</style>