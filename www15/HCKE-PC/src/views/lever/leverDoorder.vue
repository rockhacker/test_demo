<template>
  <div>
    <div class="flex alcenter plr10 baselight2">
      <div
        class="ptb5 mr30 bold ft14 pointer"
		:class="{'text-main active2px':i==index,'gray6':i!=index}"
    ...
    <div
      class="flex alcenter mb10 plr10 ft14 pt10 gray6"
    ...
    <div class="flex ft12 pb10">
      ...
      <div class="flex1 plr10 mt10 bdr38">
        <div class="flex alcenter mb10 posRelt mult gray6" v-show="index==1">
          <span class="w15 gray6">{{$t('lever.price')}}</span>
          <input
            type="number"
        ...
        <div class="flex alcenter mb10 posRelt mult">
          <span class="w15 gray6">{{$t('lever.times')}}</span>
          <el-select
        ...
        <div class="flex alcenter mb10 posRelt">
          <span class="w15 gray6">{{$t('lever.hands')}}</span>
        ...
        <div class="flex alcenter mb10">
          <span class="w15 gray6">{{$t('lever.s_dealpwd')}}</span>
          <input
            type="password"
        ...
        <div class="bggreen tc ht30 lh30 white radius2" @click="submits(1)" v-else>{{$t('lever.buy')}}</div>
      </div>
      <!-- 卖盘 -->
    ...
    <el-dialog :title="$t('lever.confrim_order')" :visible.sync="orderShow" width="30%" :before-close="handleClose">
      <div class="mb15 gray6">
        <div class="flex pb10 alcenter between gray6">
          <p>{{$t('lever.hands')}}</p>
