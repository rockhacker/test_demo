<template>
  <div>
    <div class="flex ht40 lh40 ft16 gray6">
      <!-- <div class="plr40 pointer" :class="types==6?'bgpart':''" @click="changeType(6)">{{$t('lever.dedan')}}</div> -->
      <div class="plr40 pointer" :class="types==5?'text-main active2px':''" @click="changeType(5)">{{$t('lever.current')}}</div>
      <div class="plr40 pointer" :class="types==1?'text-main active2px':''" @click="changeType(1)">{{$t('lever.allPosition')}}</div>
      <div class="plr40 pointer" :class="types==0?'text-main active2px':''" @click="changeType(0)">{{$t('lever.allWei')}}</div>
      <div class="plr40 pointer" :class="types==3?'text-main active2px':''" @click="changeType(3)">{{$t('lever.allClose')}}</div>
      <div class="plr40 pointer" :class="types==4?'text-main active2px':''" @click="changeType(4)">{{$t('lever.allBack')}}</div>
    </div>
    <div class="plr15 pb30">
      <!-- 当前挂单 -->
      <ul v-if="types==6">
        <li class="flex alcenter ptb10 gray6">
        ...
        <li v-for="(item,index) in currentDelegation" :key="index" class="flex alcenter ptb10 gray6">
          ...
          <span class="flex1 tr pointer" @click="leverClose(item.id)">{{$t('lever.chedan')}}</span>
        </li>
      ...
      <ul v-else-if="types==5">
        <li class="flex alcenter between mt10 mb10 gray6">
          <div>
          ...
          <p
            class="pointer plr15 tc ft12 gray6 radius2 bgblue txtwhite ptb5"
        ...
        <li
          class="flex alcenter ptb10 gray6"
        ...
        >
          ...
          <span class="flex1 tc" :class="item.profits < 0 ? 'red' : 'green'">{{item.profits | toFixed4}}</span>
          <span class="flex1 tc" :class="item.profits < 0 ? 'red' : 'green'">{{item.caution_money/item.profits | toFixed4}}%</span>
      ...
      <ul v-else>
        ...
        <li v-if="historyData.orderListTotal ==0">
          <div class="tc ptb40">
            <img src="../../assets/images/nodata.png" alt class="wt70" />
            <p class="gray6">{{$t('lever.noData')}}</p>
          </div>
        </li>
      </ul>
    </div>
