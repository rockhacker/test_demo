<template>
  <div>
    <div class="flex alcenter plr10 ht40 bgwhite">
      <div class="ft16 bold mr20 gray6">
        {{ currency_matchInfo.symbol }}
      </div>
      <div class>
        <div
          class="ft16"
          :class="[
            currency_matchInfo.currency_quotation.change < 0 ? 'red' : 'green',
          ]"
        >
          {{ currency_matchInfo.currency_quotation.close || "0.00" }}
        </div>
        <!-- <div
          class="ft12"
      ...
      <div class="flex1 ft12 tc">
        ...
        <div class="flex alcenter">
          ...
          <span class="flex1 gray6">{{
            currency_matchInfo.currency_quotation.high || "0.00"
          }}</span>
          <span class="flex1 gray6">{{
            currency_matchInfo.currency_quotation.low || "0.00"
          }}</span>
          <span class="flex1 gray6">{{
...
export default {
  ...
  mounted() {
    ...
    this.lang= lang || 'en';
    localStorage.setItem("leverPeriod", "1hour"); //默认为1分钟;
    this.createWidget();
  },
  destroyed(){
    this.removeWidget();
