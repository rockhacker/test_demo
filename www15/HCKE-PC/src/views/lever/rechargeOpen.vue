	...
	<div class="rechargeOpen ">
         <div class="open-header">
            ...
            ></vue-qr>
              ...
              <p class="textaddress basecolor">{{$t('feed.address')}}</p>
              <p class="address basecolor">{{obj.address}}</p>
              <button class="qr-btn white" @click="setCopy">{{$t('feed.copyadd')}}</button>
         </div>
        <div class="open-form">
				<p class="basecolor">{{$t('feed.depositsAddress')}}</p>
				<input class="ht40 lh40 plr20 borGray w100 mt10 baselight2" v-model="depositsAddress" :placeholder="$t('feed.depositsAddressUp')"/>
				<p class="basecolor mt10">{{$t('feed.deposits')}}</p>
				<input class="ht40 lh40 plr20 borGray w100 mt10 baselight2" v-model="deposits" :placeholder="$t('feed.depositsUp')"/>
        ...
        <div class="footer pb20">
            <button class="sub-btn white" @click="submit">{{$t('feed.submit_transaction_screenshot')}}</button>
        </div>
