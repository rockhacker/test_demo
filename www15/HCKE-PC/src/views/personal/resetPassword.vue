...
<div class="forget-box">
    <div class="contentBK ">
        <div class="content-wrap">
            <div class="account">
                <div class="main" >
                    <div class="main_title fColorn">{{$t('login.e_pwd')}}</div>
                    ...
                    <button class="register-button curPer" type="button" @click="resetPass" style="margin-top:20px">{{$t('login.e_confrim')}}</button>
                </div>
            </div>
        </div>
    </div>
