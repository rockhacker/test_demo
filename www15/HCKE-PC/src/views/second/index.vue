...
<div>
  <div class="w100 pt10">
    <div class="flex">
      <div class="flex3 flex column mb_mr10 bgwhite" v-if="mathid">
        <div v-if="list.length > 0 && list[currentIndex]" class="flex alcenter hidden-xs mb10">
          <p class="ft16 ml10 pointer ht40 lh40 plr10 radius4" :class="{ 'white bg-main': itm.symbol == currentSymbol,'gray6': itm.symbol != currentSymbol,}"
      ...
      <div class="h100 flex flex1 column" v-if="!soon">
        <LeverDoorder
        v-if="mathid"
          class=""
