<template>
    <div class="w100 baselight">
        ...
        <TradeHistery class="mt5" :mathid='mathid' :currencyName='currencyName' :legalName='legalName' :order='order' :neworder='neworder' v-if="!soon"></TradeHistery>
    </div>
</template>
<script>
...
export default {
    ...
    methods:{
        ...
        getcurmatchinfo(temp){
			...
			this.soon = temp.base_currency_code=='MUT' && !this.isOnline(temp.market_time);
