export default {
  ...
  login:{
		...
		r_hasaccount:'Already have an DEMO account',
		r_next:'Next',
...
"kuisun": "Deficiency breaking",
	...
	assets:{
		...
		p_transfernum:'Please enter the transfer number',
		from:'from',
		to:'to',
...
new:{
	sgjl: "Subscription records",
	jyfx: 'Trading Direction',
    cont_vol:"Cont Volume",
    leveage_ratio:"Leverage Ratio",
	avg_price:"average selling price",
  hepl:'Help',
  profit_amount:"profit and loss amount",
  order:'Position',
  verified:'Verify',
