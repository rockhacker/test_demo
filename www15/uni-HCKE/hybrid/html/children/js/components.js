Vue.component('page-footer', {
		...
		return {
			...
			transwords: {
				...
				spa: {
					...
					"numOpen": "Número de puestos vacantes",
					"openTime": "Horario de apertura",
					"Profitability": "Rentabilidad",
					"buy": "Comprar",
					"sell": "Comprar o bajar",
					"quantity": "Cantidad",
					"time": "Tiempo",
					"cancel": "Cancelar",
					"determine": "Decisiones",
					"ordered": "Pedido exitoso",
					"income": "Ingresos",
					"openNumber": "Falta de puestos vacantes",
					"contract": "Cuentas contractuales",
					"seleteNum": "Introduzca o seleccione la cantidad inicial",
					"tian": "Día",
					"shi": "Horas",
					"fenz": "Minutos",
					"miao": "Segundo"
	...
	methods: {
		secondsFormat(s) {
			...
			return day > 0 ? day + this.transwords[this.lang].tian : hour > 0 ? hour + this.transwords[this
					.lang].shi : minute > 0 ? minute + this.transwords[this.lang].fenz : second + this
				.transwords[this.lang].miao
		},
		hideBtn() {},
		getOpenTime() {
			initDataToken({
                        ...
                        <div class="children dark:children">
                            <div v-show="isSubmit" class="sub-select">
                               <!-- <div class="icon-text">
                                ...
                                <div class="footer-btn time slide-box" style="padding-bottom:10px;">
          ...
          <div>
            <div class="item" v-if="active==1" v-for="(item,index) in list" :key="index">
              <div class="item-top">
                ...
                <p>{{item.symbol_name}} {{item.seconds}}{{transwords[lang].miao}}</p>
              </div>
              <div class="item-center">
                ...
                <p>
                  ...
                  <span  :class="[item.ploss>=0? 'green':'red']">{{item.ploss>=0?'+':''}}{{item.ploss | tofixedFour}}</span>
                </p>
              </div>
              ...
              <div class="item-center">
               ...
               <!--<p>
                ...
                <p>
                  ...
                  <span :class="[item.fact_profits>=0? 'green':'red']">{{item.fact_profits>=0?'+': ''}}{{item.fact_profits}}</span>
                </p>
              </div>
            </div>
          </div>
