<template>
	...
	<view class="recharge pb-20">
		...
		<!-- <view class="recharge-header">
         ...
         <view class="recharge-content bg-my-green">
             <view class="text-white py-20" style="font-size: 20rpx;">{{$t('feed.following')}}</view>
             <view class="items">
                 <view class="item" v-for="(item,index) in wallet_data" :key="index">
                    <view class="left">
                       <image class="logo"  :src="host+item.currency.logo" ></image>
                       <text class="text text-white" style="font-size: 28rpx;">{{item.currency_code_protocol}}</text>
                    </view> 
                    <!-- <image class="icon w-14 h-26"  src="/static/image/arrrowr.png" ></image> -->
                    <view class="text-white">
						<text class="pr10" @click="detail(item)">{{$t('rechargeTransfer.linkTranster')}}</text>
						<text @click="transfer()" v-if="is_show_transfer">{{$t('rechargeTransfer.cardTranster')}}</text>
					</view>
                 </view>
             </view>
         </view>
		...
		<!-- <navigator class="recharge-content bg-my-green text-white" url="/pages/home/chat"> -->
		  <!-- <view class="left">
