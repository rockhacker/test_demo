	...
	<view  :class="theme">
	     <view class="bgPart px-30 bg-white dark:bg-floor min-h-screen">
               <view class="flex py-40" v-if="show==1">
                     <view class="flex-1 w-full h-80 flex justify-center items-center rounded-8" style="background:#0e2f1a">
               ...
               <view class="flex py-40" v-else-if="show==2">
				 ...
				 <view class="w-full flex items-center border-0 border-b-2 border-solid border-gray-200 dark:border-gray-600">
					...
					<view class="ml-20 text-primary text-xl" @click="setAll">{{$t('new.quanb')}}</view>
				 </view>
               ...
               <button class="w-full rounded-10 bg-primary text-white text-xl mt-100" @click="sub">{{$t('new.duih')}}</button>
         </view>
	</view>
</template>
