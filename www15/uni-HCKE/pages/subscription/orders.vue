<template>
	<view :class="theme">
		<view class="text-center">
			...
			<view class="flex h-100 items-center bg-white dark:bg-gray-900 text-black dark:text-gray-300 border-0 border-solid border-b-2 border-gray-200" v-for="item,index in tableData" :key="index">
