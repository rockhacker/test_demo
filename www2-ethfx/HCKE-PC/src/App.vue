<template>
  <div id="app">
    <div
      class="flex alcenter between plr20  ft14 bgwhite"
      style="height:60px;"
    >
      <div class="flex alcenter between h48 lh48 app">
		<div  class="pointer mr50 plr10 mt16 ">
			<img src="../static/imgs/wewe.png" style="height: 60px;width: auto;" @click="goHome" />
		</div>
  ...
  <div class="mr25 white pointer flex alcenter" :class="{'routeractive':selectA!=''}" slot="reference">
    <span class="black">{{selectA || $t('add.jiaoyi')}}</span>
 ...
 <el-popover
  ...
  <div class="mr25 white pointer flex alcenter" :class="{'routeractive':selectB!=''}" slot="reference">
    <span class="black">{{selectB || $t('assets.lever')}}</span>
    <img class="pl10"  :class="{'rotate':show2}" src="./assets/images/arrow-dowm.png" alt="" srcset="">
      ...
      <div class="flex alcenter between">
        ...
        >
        <div class="pointer sepoi radius2  login-btn black" style="width: 100px;">
          <el-select v-model="langname" class="flex1 black" @change="changeLang">
            <el-option
