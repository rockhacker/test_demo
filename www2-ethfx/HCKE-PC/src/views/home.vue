<template>
  <div class="home bgwhite">
    ...
    <div class="pb40" v-if="marketlist.length &&false">
		<div class="wt1200 mauto  black">
    

      <div class="flex mt30">
        <div class="flex1 mlr20" v-for="(list,oIndex) in marketlist" :key="oIndex">
        <div class="mb20">
          <span class="text-new-blue ft22">{{oIndex==1? $t('new.ysqhq'):list.code}}</span>
        </div>
        <div class="flex bg-new-blue between white alcenter plr10 ptb10 mb20 pointer"  @click="toUrl(list.matches[0])">
          <img class="wt30 radius50p" :src="list.matches[0].base_currency.logo" alt="" srcset="">
          <div class="ft18"> {{list.matches[0].symbol}}</div>
          <div class="ft18"> {{parseFloat(list.matches[0].currency_quotation.close)}}</div>
           <div class="ft26">
            {{ list.matches[0].currency_quotation.change >= 0 ? "+" : ""}}{{ (list.matches[0].currency_quotation.change - 0) | toFixed2 }}%
          </div>
        </div>
          <div class="flex ht30 alcenter bg-EDEDED black" style="border-radius: 8px 8px 0px 0px;">
        ...
        <!-- <div class="flex1"></div> -->
           ...
           <div class="flex ptb20 bg-FBFBFB pointer hover-item" style="border-bottom: 1px dashed #E6E6E6;" v-for="(item,index) in list.matches.length<4?list.matches:list.matches.slice(0,4)" :key="index"  @click="toUrl(item)">
    ...
    <div class="bg-new-red  contw  wt1200 mauto  black flex column jscenter alcenter mb20" style="border-radius: 20px 20px 0px 0px;">
       <div class="flex alcenter jscenter">
        <img src="/static/imgs/red-line.png" alt="" srcset="">
        <span class="tc ft28 bold plr20 white">{{ $t("new.shijie") }}</span>
         <img style="transform: rotateY(180deg);" src="/static/imgs/red-line.png" alt="" srcset="">
      </div>
    ...
    <div class="bg-new-blue  contw  wt1200 mauto  black flex column jscenter alcenter" style="border-radius: 0px 0px 20px 20px;">
      <div class="flex alcenter">
        <div class="posRelt pb90">
              <div class="white ft24 tr">{{ $t("new.an") }}</div>
              <p class="ft12 mb10 white tr">{{ $t("new.zai") }}</p>
              <div class="abstort bg-new-red radius50p wt80 ht80 flex alcenter jscenter" style="right:-100px;top:-10px">
          ...
          <img class="mt20" src="/static/imgs/jieshao1.png" alt="">
           <div class="ml20 posRelt">
              ...
              <p class="ft12 white">{{ $t("new.zuo") }}</p>
               <div class="abstort bg-new-red radius50p wt80 ht80 flex alcenter jscenter" style="left:-100px;top:-10px">
    ...
    <div class="bgwhite contw contbg">
      <div class="flex alcenter jscenter">
        ...
        <span class="tc ft28 bold plr20 text-new-blue">{{ $t("new.kai") }}</span>
      ...
      <div class="mt50 flex alcenter jscenter mauto tc">
        <div class="bg-new-blue f-right m-item radius8 pt20">
          <img src="../assets/images/ghfnghmh.png" alt="" class="wt50" />
          <div class="mt20">
            <p class="bold ft16 mb20 white">{{ $t("new.shou") }}</p>
            <p class="ft12 mb10 white">{{ $t("new.shi") }}</p>
            <p class="ft12 white">{{ $t("new.fe") }}</p>
          </div>
        </div>
        <div class="f-right m-item bg-new-purple radius8 pt20">
          <img src="../assets/images/hmhgm.png" alt="" class="wt50" />
          <div class="mt30">
            <p class="bold ft16 mb20 white">{{ $t("new.you") }}</p>
            <p class="ft12 mb10 white">{{ $t("new.hui") }}</p>
            <p class="ft12 white">{{ $t("new.xiang") }}</p>
          </div>
        </div>
        <div class="m-item bg-new-red radius8 pt20">
          <img src="../assets/images/gnhmnh.png" alt="" class="wt50" />
          <div class="mt20">
            <p class="bold ft16 mb20 white">{{ $t("new.ke") }}</p>
            <p class="ft12 mb10 white">{{ $t("new.quan") }}</p>
            <p class="ft12 white">{{ $t("new.di") }}</p>
          </div>
        </div>
      </div>
      <!-- <button class="k-btn" @click="toPath">{{ $t("new.yi") }}</button> -->
    </div>
    <div class="bg-new-blue pt30 pb30">
    ...
    <div class="bgwhite pt30 pb30">
       ...
       <div>
         <div class="flex alcenter jscenter">
        <img src="/static/imgs/green-line.png" alt="" srcset="">
        <span class="tc ft28 bold plr20 text-new-blue">{{$t('new.jies')}}</span>
         <img style="transform: rotateY(180deg);" src="/static/imgs/green-line.png" alt="" srcset="">
      </div>
    ...
    <div class="flex alcenter">
      <video id="myVideo" class="mb20 w70 mauto" src="
https://exchange-hk.oss-cn-hongkong.aliyuncs.com/ethfx/IMG_0637.MP4" controls="controls" ></video>
    </div>
    </div>
