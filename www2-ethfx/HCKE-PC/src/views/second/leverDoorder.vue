<template>
  <div class="p-10">
    <div class="tc flex  bgwhite dark-bg-1C2532 ft14">
      <div class="flex1 hidden-xs bg-main-liner ptb20 radius6">
        <div class="flex jscenter alcenter ft16 text-clip-yellow">
          <!-- <img src="../../assets/images/money.png" alt> -->
          <p>{{$t('assets.microacc')}}</p>
        </div>
        <p class="pt15 ft22 white" v-if="wallet_list.length&&wallet_list[modelIndex]">{{wallet_list[modelIndex].micro_account.balance}} {{wallet_list[modelIndex].code}}</p>
        <!-- <ul>
    ...
    <div class="mt20">
      <div class="dark-bg-1C2532 flex alcenter ft14 ptb10 plr20">
    ...
    <div class="name">{{ parseFloat(item.number) }}</div>
      ...
      <div class="bg-main-liner ptb20 flex hidden-xs radius6">
      ...
      <div class="mt20 nmb_mt20 flex" v-else>
        <div class="flex1 bg-k-green tc ptb10 ft16 white radius40 flex alcenter jscenter pointer mb_btn mr20" @click="submits(1)" >
          <img src="../../assets/images/miaoIcon_18.png" alt="">
          <span class="white">{{$t('second.buyUp')}}</span> 
        </div>
        <div class="flex1 bg-k-red tc ptb10 ft16 white radius40 flex alcenter jscenter pointer mb_btn" @click="submits(2)" >
