  ...
  <view class="pb-200">
	  <view>
		<view class="header ww mb-20 mt-40">
		  <view class="item mr20 text-xs rounded-8" :class="item.id == active ? 'text-new-blue border-2 border-solid border-new-blue' : ''" v-for="(item, index) in list" :key="index" @click="setActive(item)">
				{{ item.symbol }}
		  </view>
		</view>
		...
		<view class="mx-20 bg-white dark:bg-1C2532 rounded-10 py-20">
			...
			<view class="no-active text-lg py-8" :class="{'text-new-blue border-0 border-b-2 border-solid border-new-blue':showType==0}" @click="changeShow(0)">{{$t('qqjy.wqjg')}}</view>
			<view class="no-active text-lg py-8" :class="{'text-new-blue  border-0 border-b-2 border-solid border-new-blue':showType==1}" @click="changeShow(1)">{{$t('qqjy.sshq')}}</view>
		</view>
		...
		<view class="cont mt-20">
		  ...
		  <view class="pb-16 bg-new-blue mx-20 rounded-10">
		 	<view class="gress ww">
		 ...
		 <view class="number ww">
			<view
			  class="items"
			  :class="timeItem.id == item.id ? 'text-new-blue border-2 border-solid border-new-blue' : ''"
		  ...
		  <view class="number ww">
			<view class="items" :class="amount.id == item.id ? 'text-new-blue border-2 border-solid border-new-blue' : ''" v-for="(item, index) in amountList" :key="index" @click="setBala(item)">
		...
		<view class="tabs ww">
		  <view class="tab-text">
			<view
			  class="tab-item"
			  :class="textAc == 1 ? 'text-new-blue border-0 border-b-2 border-solid border-new-blue' : ''"
			  @click="setText(1)"
			  >{{ $t("new.current") }}</view
			>
			<view
			  class="tab-item"
			  :class="textAc == 3 ? 'text-new-blue border-0 border-b-2 border-solid border-new-blue' : ''"
			  @click="setText(3)"
