<template>
	<view :class="theme" class="rechargeOpen">
         <view class="bg-my-grey dark:bg-1C2532 flex justify-center items-center flex-col p-30">
			  ...
			  <button class="w-full rounded-10 bg-new-blue text-white text-xl" @click="setCopy">{{$t('feed.copyadd')}}</button>
			  ...
			  <button class="w-full rounded-10 bg-new-blue text-white text-xl" @click="submit">{{$t('feed.submit_transaction_screenshot')}}</button>
