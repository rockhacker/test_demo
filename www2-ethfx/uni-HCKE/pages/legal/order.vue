<template>
	<view class="" :class="{'light':theme=='light'}">
		<view class="status_bar bg-new-blue">
			<view class="top_view bg-new-blue"></view>
		</view>
		<view class="header fixed flex alcenter between plr15 bg-new-blue">
			<view>
				<image src="../../static/image/forward.png" mode="aspectFit" class="wt20 h20" @click="back()"></image>
			</view>
		</view>
		<view class="">
			<view class="done flex between alcenter pt60 plr15 pb15 bg-new-blue">
			...
			<view class="price flex column plr15 ptb15">
				<view class="flex alcenter">
					<text class="mr5 text-new-blue ft18 bold" v-if="data.area_info">{{data.amount}} {{data.area_info.currency}}</text>
		...
		<uni-popup ref="ceil" :type="type" :custom="true">
			...
			<view class="uni-tip" v-if="payType=='ceil'">	
				...
				<view class="uni-tip-content flex column white ft12">
					<text class="text-new-blue">{{$t('store.t_tip1')}}</text>
				...
				<view class="uni-tip-group-button">
					...
					<view class="uni-tip-button text-new-blue" @click="cancel('ceil'),submit()">{{$t('login.e_confrim2')}}</view>
				</view>
			</view>
			<view class="uni-tip" v-if="payType=='ipay'">	<!-- 确认付款弹窗 -->
				...
				<view class="uni-tip-content white tc ft12">
					<text class="text-new-blue">{{$t('store.donotconfrim')}}。</text>
			...
			<view class="uni-tip" v-if="payType=='depay'">	<!-- 延期确认弹窗 -->
				...
				<view class="uni-tip-content white tc ft12">
					<text class="text-new-blue">{{$t('store.notpayconfrim')}}。</text>
