<template>
	<view :class="theme">
		<view class="p-30 bg-my-grey dark:bg-my-black ">
			<view class="bg-white dark:bg-1C2532 p-20 mb-20 rounded-8">
				...
				<view v-if="subscription.currency && subscription.currency.desc">
					<view class="text-xl mb20 text-black dark:text-white">{{$t('subscription.bizhongjieshao')}}</view>
					<view class="flex1 text-black dark:text-white break-all">{{subscription.currency.desc}}</view>
				</view>
			</view>
		</view>
    </view>
