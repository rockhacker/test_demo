<template>
	<view class="min-h-screen" :class="theme">
		<view class="min-h-screen bg-my-grey dark:bg-my-black">
			...
			<slot name="right">
				<navigator url="./orders" class="px-10 py-10 border-solid border-2 border-new-blue rounded-10 absolute top-24 right-20 z-10 text-new-blue" >{{$t('subscription.my_subscription')}}</navigator>
			</slot>
		</uni-nav-bar>
