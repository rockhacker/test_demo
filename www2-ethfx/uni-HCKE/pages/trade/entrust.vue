	...
	<view class="" :class="{'light':theme=='light'}">
		<view class="flex flexend between plr15 ptb10 w100 bdb_1e fixed lf0 bgPart zdx100">
			<view class="flex flexend">
				<view :class="['ft14 gray7',{'ft18 text-new-blue':current==0}]" @click="change(0)">{{$t('trade.all_delegate')}}</view>
			    <view :class="['pl10 ft14 gray7',{'ft18 text-new-blue':current==1}]" @click="change(1)">{{$t('trade.his_delegate')}}</view>
			</view>
