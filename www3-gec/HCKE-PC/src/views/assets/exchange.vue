  ...
  <div class="mymention pb60">
    ...
    <div class="mt20 plr30">
      ...
      <div class="flex alcenter wt500 mb40 duih mt40">
        <span class="wt100 white">{{ $t("new.dhs") }}:</span>
        <input
          type="text"
          v-model="num"
          class="ht40 lh40 plr20 bdinput flex1 baselight2"
        />
        <p class="quanb white" @click="setAll">{{ $t("new.quanb") }}</p>
      </div>
      <div class="text-flex wt500 white">
        <div class="top child">
          <span>{{ $t("new.dangq") }}</span>
          <span>{{ $t("new.keyong") }}</span>
          <span>{{ $t("new.ked") }}</span>
        </div>
        <div class="bottom child white">
          <span>{{ rate }}</span>
      ...
      <div
        class=" btn mt30 radius2 tc ht48 lh48  wt500  white bg-my-orange"
        @click="sub"
      >
        {{ $t("new.duih") }}
      </div>
