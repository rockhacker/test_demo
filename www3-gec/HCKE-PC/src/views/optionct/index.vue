<template>
    <div>
        <div class="bgseca bgpart optionct">
            <div class="cont">
                 <div class="tabs nwhite">
                     <p class="tab-item" :class="index==active?'active':''" @click="setActive(index,item)" v-for="(item,index) in list" :key="index">{{item.symbol}}{{$t('new.contract')}}</p>
                 </div>
                 <div class="tab-content conbg">
                       <div class="tab-time">
                       ...
                       <div class="tab-cont">
                             <div class="tab-header nwhite">
                                    <p class="header-item mr30" :class="isTitle==0?'active':''" @click="isTitle=0">{{$t('new.pastres')}}</p>
                                    <p class="header-item" :class="isTitle==1?'active':''" @click="()=>{isShow=true;isTitle=1}">{{$t('new.realime')}}</p>
                             </div>
                       ...
                       <div class="qidetail">
                                ...
                                <p class="yue">{{$t('new.balance')}}: {{balance.balance}} USDT</p>
                                <div class="btn">
                                     <button class="zhang" @click="submit(1)">{{$t('new.bullish')}}</button>
                                     <button class="die" @click="submit(2)">{{$t('new.bearish')}}</button>
                                </div>
                       </div>
                     
                 </div>
                 <div class="tabs">
                    <div class="tab" :class="tabAc==1?'active':''" @click="getData(1)">{{$t('lever.current')}}</div>
                    <div class="tab" :class="tabAc==3?'active':''" @click="getData(3)">{{$t('store.orderlist')}}</div>
                 </div>
    ...
    <style lang="scss">
     .optionct{
         ...
         .cont{
             ...
             .tabs{
                 ...
                 .tab-item{
                     ...
                     cursor: pointer;
                     &.active{
                         border-bottom: 4px solid #F3A907;
                         color:#F3A907;
                     }
                     &:first-child{
                      margin-left:13px;
         ...
         .active{
             color:#F3A907 !important;
             border-color:#F3A907 !important;
         }
         .tabs{
             display: flex;
             padding-left:16px;
