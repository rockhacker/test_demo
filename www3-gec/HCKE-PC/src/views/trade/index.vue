<template>
    <div class="w100 baselight bgblack">
        <div class="flex alcenter mt5 vh80 bgblack" style="min-height:710px">
            <!-- 左侧行情 -->
        ...
        <TradeHistery class="mt5 bgblack" :mathid='mathid' :currencyName='currencyName' :legalName='legalName' :order='order' :neworder='neworder' v-if="!soon"></TradeHistery>
    </div>
</template>
<script>
...
export default {
    ...
    methods:{
        ...
        getcurmatchinfo(temp){
			...
			this.soon = !this.isOnline(temp.market_time);
