<template>
    <div class="flex h100">
                ...
                <div class="bgheader bdbheader flex alcenter plr10 ht40">
                    ...
                    <div v-if="tradeList.length>0 && tradeList[currentIndex]">
                        <div class="flex alcenter ptb5 markethover pointer" :class="{'bgshadow':itm.symbol==symbol}"  v-for="(itm,j) in tradeList[currentIndex].matches" v-if="itm.open_change==1"  :key="j" @click="$emit('changeSymbol',j)">
							...
							<div v-if="!isOnline(itm.market_time)" class="mlr10">{{$t('trade.soon')}}</div>
							<template v-else >
                    ...
                    <div class="flex1 ft12  flex ml30">
                        ...
                        <div class="mr30">
                            ...
                            <div class="flex1">{{$t('add.24hcje')}}(USDT)</div>
		...
		<template v-if="!soon">
			...
			<!-- 下单 -->
			<div class="bgblack" style="width:290px;height:100%">
                ...
                <div class="flex mlr10 pointer" style="border-radius:2px;overflow: hidden;">
                    <!-- <el-button-group class="flex1">
                        ...
                        <div class="flex1 posRelt bggreen" @click="markType=0" style="height:34px;text-align: center;line-height: 34px;color:#fff;font-size:16px">{{$t('trade.buy')}}
                            <div class="abstort top0 rt0 btm0" :style="{'border-top': `16px solid `+(theme=='dark'?'#0B0E11':'#fff'),'border-left': `16px solid transparent`, 'border-bottom':` 18px solid `+(theme=='dark'?'#0B0E11':'#fff')}">
                        ...
                        <div class="flex1 posRelt bgred" @click="markType=1" style="height:34px;text-align: center;line-height: 34px;color:#fff;font-size:16px">{{$t('trade.sell')}}
                            <div class="abstort top0 lf0 btm0" :style="{'border-top': `16px solid `+(theme=='dark'?'#0B0E11':'#fff'),'border-right': `16px solid transparent`, 'border-bottom':` 18px solid `+(theme=='dark'?'#0B0E11':'#fff')}">
                ...
                <div class="bdbheader flex alcenter bold bgheader flex1 pt7 pl5">
                    <div class="pb10 mr20 pointer ft14 bd2px active2px" >{{options[1]}}</div>
                </div>
                <div class="flex1  bgblack overy flex">
                    <div class=" ptb10 flex1 flex column w100  " >
                       ...
                       <div class="flex1  mt10 " >
                            <div class="overyscroll plr10" style="height: 360px;">
        ...
        <div class="flex column overy" style="width:300px;height:100%">
            <div class="flex">
                <div class="bdbheader flex alcenter bold bgheader flex1 pt7 pl5">
                    <div class="pb10 mr20 pointer ft14 bd2px active2px" >{{options[0]}}</div>
                </div>
            ...
            <div class="flex1 flex">
                <div class="flex column w100 flex1 bgblack" v-show="optionIndex==0">
                    <div class="ptb10 flex1 flex column w100">
                        <div class="flex alcenter plr10 ">
                        ...
                        <!-- 买盘 -->
                        <div class="bgblack mt10 flex1 flex column bids">
