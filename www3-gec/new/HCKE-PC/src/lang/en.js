export default {
	...
	staking:{
		...
		describe1: 'What is cryptocurrency mining? Whether it is called currency mining or cryptocurrency mining, or simply "mining", it refers to the process of generating or earning new currency. Although there are subtle differences between different currencies, mining mainly refers to the process of verifying transactions in the blockchain system, and users who perform this verification process will receive a fee as a reward. Specifically, users can earn currency by helping to validate the blockchain and the ledger of transactions contained within it.',
	...
	"add": {
		...
		"jrzd": "It's up today",
		"24hcje": "24h turnover",
		"qxsd": "Canadian currency ushers in a new era",
		"czzzbg": "Help you create, add value and keep wealth",
		"djxn": "Top performance, how fast to trade",
		"djxn_desc": "London stock exchange technology driven, ultra-low delay late, how to match the speed",
		"zjbz": "How to guarantee the safety of funds",
		"zjbz_desc": "CCSS meets the standards and ensures the security of capital ratio data",
		"gld": "High flow, low difference",
		"gld_desc": "Contract leverage trading, super efficiency, minimum slip",
		"qthfw": "24 / 7 service",
		"qthfw_desc": "I guarantee the system's good luck and provide round the clock customer service",
		"bjyy": "Convenient and easy to operate",
		"bjyy_desc": "It provides a booking order system than a trading tool, and the risk is controllable",
		"sssd": "Good deal anytime, anywhere",
		"sssd_desc": "The podium provides Web version, mobile application and API connection than fix",
		"aqpt": "Secure and trusted lost podium",
		"aqpt_desc": "BTC / eth contract transactions play leverage and cross cattle and bears"
	},
	"financial": {
		"financial": "financial",
		"rule": "rule",
		...
		"zd": "minimum",
		"zg": "highest",
		"sysm": "That is: after 5 days, you can get 250u of cheap money. The cheap money will be distributed every day. The distributed cheap money can be accessed at any time. The deposited money will be automatically returned to your account when it expires.",
