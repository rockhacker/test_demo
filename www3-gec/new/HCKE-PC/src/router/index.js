...
import financialRule from '@/views/financial/rule'
import financialBuy from '@/views/financial/buy'
import financialConfirm from '@/views/financial/confirm'
import financialWdtg from '@/views/financial/wdtg'
import financialIncome from '@/views/financial/income'

import invite from '@/views/invite'
import inviteRule from '@/views/invite/rule'
