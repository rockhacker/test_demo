<template>
  <div class="mymention pb60">
    ...
    <div class="mt20 plr30">
      <div class="flex alcenter mb20 white">
      ...
      <div class="flex alcenter flex1 mb20">
        <span class="wt100 white">{{$t('bind.addr')}}:</span>
      ...
      <div style="margin-left:100px;" class="mt30 radius2 ft16 tc ht48 lh48 white bg-my-orange" @click="bindAddress">{{$t('bind.bind')}}</div>
    </div>
  </div>
</template>
<script>
