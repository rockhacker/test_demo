<template>
  <div class="home bgblack">
    <div class="block myswiper" style="width: 1280px;margin: 60px auto 0;">
      <el-carousel height="393px">
        <el-carousel-item v-for="(item, i) in swipers" :key="i">
          ...
          <div class="block w100 h100 swiperhover bgheader">
            <img :src="item.banner" alt="" class="w100 h100" style="" />
          </div>
        </el-carousel-item>
      </el-carousel>
    </div>
	<div class="ptb40">
      ...
      <div class="ft24 tc mb20" v-if="lang!='vn'">{{$t('lever.price')}}</div>
      <div class="ft24 tc mb20" v-else>Phổ biến</div>
      <div class="flex ht50 alcenter bg-main">
        <div class="flex1 tc ft16">{{$t('trade.currency')}}</div>
        <div class="flex1 tc ft16" v-if="lang!='vn'">{{$t('lever.price')}}</div>
         <div class="flex1 tc ft16" v-else>Giá thị trường</div>
        <div class="flex1 tc ft16"  v-if="lang!='vn'">{{$t('add.jrzd')}}</div>
        <div class="flex1 tc ft16" v-else>Tăng giảm</div>
        <div class="flex1 tc ft16">{{$t('market.high')}}</div>
        <div class="flex1 tc ft16">{{$t('market.low')}}</div>
        <!-- <div class="flex1 tc">24H</div> -->
        <div class="flex1 tc ft16">{{$t('add.24hcje')}}(USDT)</div>
        <div class="flex1"></div>
      </div>

      <div>
        <div class="flex ptb20" style="border:0 solid #333333;border-bottom-width: 1px;" v-for="(item,index) in marketlist" :key="index">
          <div class="flex1 tc ft16">
            {{item.symbol}}
          </div>
          <div class="flex1 tc ft16">

            <span v-if="!isOnline(item.market_time)">{{$t('trade.soon')}}</span>
            <span v-else>{{parseFloat(item.currency_quotation.close)}}</span>
          </div>
          <div class="flex1 tc ft16">
            <span
			  :class="{
          ...
          <div class="flex1 tc ft16">
           ...
           <!-- <div class="wt150 tc">
            {{item.currency_quotation.amount}}
          </div> -->
           <div class="flex1 tc ft16">
            {{item.currency_quotation.volume}}
          </div>
          <div class="flex1 tc">
            <span class="pointer ft16 border-main plr10" @click="toUrl(item)" style="border-radius: 15px;">
    ...
    <div class="mauto" style="width:1000px">

        <div class="tc ft24 bold">{{$t('add.qxsd')}}</div>
        <div class="tc mt14 ft14" style="color:#888888">{{$t('add.czzzbg')}}</div>
        <div>
          <div class="flex around">
            <div>
              <img src="../assets/images/djxn.png" style="width:244px;height:244px">
              <div class="tc mb10">
                {{$t('add.djxn')}}
              </div>
              <div class="tc" style="color: #888888;">
                {{$t('add.djxn_desc')}}
              </div>
            </div>
            <div>
              <img src="../assets/images/zjbz.png" style="width:244px;height:244px">
              <div class="tc mb10">
                {{$t('add.zjbz')}}
              </div>
              <div class="tc" style="color: #888888;">
            ...
            <div>
              <img src="../assets/images/gld.png" style="width:244px;height:244px">
              <div class="tc mb10">
                {{$t('add.gld')}}
              </div>
              <div class="tc" style="color: #888888;">
          ...
          <div class="flex around">
            <div>
              <img src="../assets/images/qthfw.png" style="width:244px;height:244px">
              <div class="tc mb10">
                {{$t('add.qthfw')}}
              </div>
               <div class="tc" style="color: #888888;">
            ...
            <div>
              <img src="../assets/images/bjyy.png" style="width:244px;height:244px">
              <div class="tc mb10">
                {{$t('add.bjyy')}}
              </div>
               <div class="tc" style="color: #888888;">
            ...
            <div>
              <img src="../assets/images/sssd.png" style="width:244px;height:244px">
              <div class="tc mb10">
                {{$t('add.sssd')}}
              </div>
               <div class="tc" style="color: #888888;">
    ...
    <div style="margin-top:80px">
      <div class="tc ft24 bold">{{$t('add.aqpt')}}</div>
      <div class="tc mt14 ft14" style="color:#888888">{{$t('add.aqpt_desc')}}</div>
      <div class="tc" style="margin-top:40px">
        <img src="../assets/images/aqkebg.png" style="height:490px;width:800;" alt="" srcset="">
      </div>
      ...
      <div class="alcenter mt30 w70 mauto">
          ...
          <div class="pl10 flex">
            <el-popover
              ...
              <vue-qr
                  ...
                  :size="140"
                />
              <div class="flex alcenter mb30 f-right d-item"
            ...
            <el-popover
              ...
              <span class="pl10 ft14">IOS {{ $t("home.downs") }}</span>
              </div>
            </el-popover>
            <!-- <div
              class="flex alcenter mb30 f-right d-item ngh"
              ...
              @click="downLoad"
            >
              <span class="pl10 ft14">{{ $t("login.downApp") }}</span>
            </div> -->
            <!-- <el-popover
              placement="top"
              trigger="click">
        ...
        <!-- <div class="flex1 tc posRelt">
          <img src="../assets/images/image@2x.png" alt="" class="w80" />
          <div class="abstort rt0" style="top: 35%">
            <img src="../assets/images/exmobile.png" alt="" class="wt160" />
          </div>
        </div> -->
      </div>
      <div style="width: 1000px;" class="mauto">
        <div class="tc ft18">{{$t('new.jies')}}</div>
        <div class="mt20 mb20" style="letter-spacing: 1px;">{{$t('home.gsjs')}}</div>
        <iframe width="100%" height="411" src="https://www.youtube.com/embed/4oB6BnYtxbk" title="Blockchain Explained" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
   
    </div>


    <!-- <div class="bgwhite contw bggred" >
      <div class="logos">
      ...
      <p class="tc ft24 bold">{{ $t("new.shijie") }}</p>
      <p class="tc mt14 ft14">
        {{ $t("new.all") }}
      </p>
      <div class="mt50 flex alcenter jscenter mauto tc">
        <div class="f-item f-right">
          <img src="../assets/images/qwrqwr.png" alt="" class="wt50" />
          <div class="mt5">
            <p class="bold ft16 mb20 title">{{ $t("new.an") }}</p>
            <p class="ft12 mb10">{{ $t("new.zai") }}</p>
            <p class="ft12">{{ $t("new.zhuan") }}</p>
          </div>
        </div>
        <div class="f-item f-right">
          <img src="../assets/images/wfegfbhrf.png" alt="" class="wt50" />
          <div class="mt5">
            <p class="bold ft16 mb20 title">{{ $t("new.shis") }}</p>
            <p class="ft12 mb10">
              {{ $t("new.wo") }}
            </p>
            <p class="ft12">{{ $t("new.zuo") }}</p>
          </div>
        </div>
        <div class="f-item">
          <img src="../assets/images/wegegbefbh.png" alt="" class="wt50" />
          <div class="mt5">
            <p class="bold ft16 mb20 title">{{ $t("new.hu") }}</p>
            <p class="ft12 mb10">{{ $t("new.jian") }}</p>
            <p class="ft12">{{ $t("new.li") }}</p>
          </div>
        </div>
      </div>
    </div> -->
    <!-- <div class="bgwhite contw bgpart contbg">
      <p class="tc ft28 bold">{{ $t("new.kai") }}</p>

      <div class="mt50 flex alcenter jscenter mauto tc">
        <div class="f-item f-right m-item" :class="lang">
          <img src="../assets/images/ghfnghmh.png" alt="" class="wt50" />
          <div class="mt20">
            <p class="bold ft16 mb20 title">{{ $t("new.shou") }}</p>
            <p class="ft12 mb10">{{ $t("new.shi") }}</p>
            <p class="ft12">{{ $t("new.fe") }}</p>
          </div>
        </div>
        <div class="f-item f-right m-item" :class="lang">
          <img src="../assets/images/hmhgm.png" alt="" class="wt50" />
          <div class="mt20">
            <p class="bold ft16 mb20 title">{{ $t("new.you") }}</p>
            <p class="ft12 mb10">{{ $t("new.hui") }}</p>
            <p class="ft12">{{ $t("new.xiang") }}</p>
          </div>
        </div>
        <div class="f-item m-item" :class="lang">
          <img src="../assets/images/gnhmnh.png" alt="" class="wt50" />
          <div class="mt20">
            <p class="bold ft16 mb20 title">{{ $t("new.ke") }}</p>
            <p class="ft12 mb10">{{ $t("new.quan") }}</p>
            <p class="ft12">{{ $t("new.di") }}</p>
          </div>
        </div>
      </div>
      <button class="k-btn" @click="toPath">{{ $t("new.yi") }}</button>
    </div> -->
    <!-- <div class="downinfo bggred pt30 pb90">
      <div class="tc ft24 bold">{{ $t("home.c12") }}</div>
      <div class="mt20 ft14 tc">
        {{ $t("new.gai") }}
      </div>
      
	  <div class="jieshao">
	         <h1 class="title">{{$t('new.jies')}}</h1>
	         <div class="content" v-html="$t('new.jiec')"></div>
...
export default {
    components:{footerComponet,vueQr},
    data(){
        return{
            swipers:[],
            marketlist:[
    ...
    //             });
                console.log(this.marketlist,22)
            })
        },
        // 链接socket
        bindSocket(){
                ...
                socket.on('DAY_MARKET',msg=>{
                    for (var i = 0; i < this.marketlist.length; i++) {
                        if (this.marketlist[i].id == msg.currency_match_id) {
                            ...
                            this.marketlist[i].currency_quotation.amount = msg.quotation.amount;
                            this.marketlist[i].currency_quotation.volume = msg.quotation.volume;
                            this.marketlist[i].currency_quotation.open = msg.quotation.open;
                        }
                    }
                })
            })
