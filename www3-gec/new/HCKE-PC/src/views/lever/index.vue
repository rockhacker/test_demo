<template>
  <div class="w100 baselight bgblack">
    <div class="flex mt5 vh0 bgblcak" style="min-height: 800px;">
      <!-- 左侧行情 -->
      <div class="wt240 bd mr5 bgblcak ptb10 radius2 h0">
          ...
          <div v-if="list.length > 0 && list[currentIndex]">
            ...
            >
              ...
              <div
                ...
                v-if="(itm.base_currency_code=='GexCoin'?isOnline(itm.market_time):true) && itm.currency_quotation"
              >
...
export default {
  ...
  computed:{
	 ...
	 soon(){
		return this.currency_matchInfo.base_currency_code=='GexCoin' && !this.isOnline(this.currency_matchInfo.market_time)
	 }
  },
  created() {
