	...
	<div class="rechargeOpen ">
         <div class="open-header f-item">
            ...
            ></vue-qr>
              ...
              <button class="qr-btn white bg-my-orange" @click="setCopy">{{$t('feed.copyadd')}}</button>
         </div>
         <div class="open-form">
        ...
        <div class="footer">
            <button class="sub-btn bg-my-orange white" @click="submit">{{$t('feed.submit_transaction_screenshot')}}</button>
        </div>
