<template>
  <div class="pb20 collectionSettings">
    <div class="pt20 ml20 w60 flex between alcenter">
      <span>{{$t('collect.method')}}</span>
      <el-select v-model="payName" class="ht40 lh40 radius2 ml10 w70 nwhite bdinput" @change="changePay" placeholder="">
    ...
    <!-- 银行卡 -->
    <ul class="pt20 ml20 w60" v-else-if="payType=='bank'">
      <li class="flex between alcenter">
        <div>
           <span>{{$t('collect.name')}}：</span>
           <span class="red">✳</span>
        ...
        <input
          ...
          v-model="realName"
          :placeholder="$t('collect.p_name')"
          class="ht30 bdinput lh30 plr10 radius2 ml10 w70 nwhite"
        />
      </li>
      <li class="flex between alcenter mt20">
         <div>
    ...
    <ul class="ml20 w60">
      <li class="flex between alcenter">
        <span> </span>
        <div
      class="bgblue ht40 flex alcenter jscenter mt40 white radius6 ft16"
    ...
    <div class="mt30 ml20">
					 <div>{{ $t('assets.remarks') }}:</div>
					 <div class="mt20">1.{{ $t('home.beizhu1') }}</div>
					 <div class="mt10">2.{{ $t('home.beizhu2') }}</div>
					 <div class="mt10">3.{{ $t('home.beizhu3') }}</div>
		</div>
    <!-- <div
