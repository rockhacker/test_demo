<template>
	<div class="minh100 ft16 bgblack">
		...
		<div class="mauto pt20 wt1200 pb80">
			...
			<el-card class="box-card f-item mb20 white" v-for="item,index in stakingData" :key="index">
				<div class="flex between plr10 ptb10">
					 ...
					 <div class="flex1 flex column between">
						 <div class="flex jsend">
							<el-button type="warning" class="wt100 mr10" style="border-radius: 0;background:#01ad95;border-color:#01ad95;" @click="$router.push({path:`/stakingDetails?id=${item.id}`})">{{$t('staking.shengou')}}</el-button>
						 </div>
