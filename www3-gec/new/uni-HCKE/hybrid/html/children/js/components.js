                        ...
                        <div class="children dark:children">
                            <div v-show="isSubmit" class="sub-select">
                               <!-- <div class="icon-text">
                                ...
                                <div class="footer-btn time  flex-wrap" style="padding: 10px 0;">
                                ...
                                <div class="foot-btn" >
									<div class="numinput dark:numinput">
                                        <input class="flex1" type="number" :placeholder="transwords[lang].md + toThousands(openTimeTtem.limit_amount)" v-model="num">
            ...
            <div class="item" v-if="active==1" v-for="(item,index) in list" :key="index">
              ...
              <div class="item-center">
                ...
                <p>
                  ...
                  <span>{{price ? price : window.price||0.0000}}</span>
                </p>
                <p>
