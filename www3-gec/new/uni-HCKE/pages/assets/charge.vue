<template>
	<view :class="theme">
		<view class="">
			...
			<view class="p-30" v-if="walletData.length > 1">
				...
				<view class="flex mt-20">
					<view v-for="item, index in walletData" :key="index" class="rounded-2xl mr-20 px-30 py-12 border-2 border-solid"
		...
		<view class="p-30 flex justify-between mt-20 items-center" v-if="labelText">
			...
			<view class="w-160 h-60 flex justify-center items-center bg-my-orange rounded-10" @tap="copyLabel">复制标签</view>
		</view>
		<view class="mt-20 p-30 text-center">
			...
			<view class="mt-20 mx-auto w-160 h-60 rounded-10 flex justify-center items-center bg-my-orange" @tap="fuzhi_invite">{{ $t('assets.coypaddr') }}</view>
		</view>
		<view class="p-30 text-my-orange">
			<!-- <view class="mb-10">
