<template>
	<view :class="theme">
		...
		<view class="p-30">
			<view class="flex items-center justify-between border-2 border-solid border-my-gray rounded-10">
				<view class="flex items-center flex-1">
					<view class="flex flex-col items-center px-30">
						<text class="w-10 h-10 rounded-half bg-blue-500"></text>
						<view class="w-4 h-40 my-10 bg-gray-200 dark:bg-gray-800"></view>
						<text class="w-10 h-10 rounded-half bg-danger"></text>
					</view>
					<view class="flex-1">
		...
		<view class="mt-20">
			...
			<view class="px-30 flex items-center justify-between border-0 border-b-2 border-solid border-gray-200 dark:border-gray-800">
				...
				<view class="flex items-center">
					<text class="blue ft14 pr10 bdr_white50 text-white" v-if="coinInfo.currency.code">{{ coinInfo.currency.code || '--' }}</text>
					<view class="pl-20 text-my-orange text-lg" @tap="all">{{ $t('trade.all') }}</view>
				</view>
			</view>
			...
			<view class="px-30 py-20">
				<view class="bg-my-orange text-white rounded-10 p-30 text-lg text-center" @tap="transfer" hover-class="opacity-50">{{ $t('assets.transfer') }}</view>
			</view>
		</view>
		
		<view class="py-30 mt-20" style="min-height:50vh">
