	...
	<view :class="theme">
		<view class="p-30">
			...
			<view v-if="types=='alipay'">
				<view class="flex items-center bg-my-gray rounded-xl px-20 py-10 mb-30">
			...
			<view v-else>
				<view class="flex items-center bg-my-gray rounded-xl px-20 py-10 mb-30">
					<view class="flex items-center">
						<view class="text-right">{{$t('collect.name')}}:</view>
						<view class="ft16 red3">*</view>
					</view>
					<input type="text"  v-model="name" class="h-80 flex-1 pr-20 text-right" :placeholder="$t('collect.p_name')">
				</view>
				<view class="flex items-center bg-my-gray rounded-xl px-20 py-10 mb-30">
					<view class="flex items-center">
						<view class="text-right">{{$t('collect.bank')}}:</view>
						<view class="ft16 red3">*</view>
					</view>
				...
				<view class="flex items-center bg-my-gray rounded-xl px-20 py-10 mb-30">
					<view class="flex items-center">
						<view class="text-right">{{$t('collect.no')}}:</view>
						<view class="ft16 red3">*</view>
					</view>
			...
			<button class="w-full rounded-3xl bg-my-orange text-white text-xl" @tap="confirm">{{$t('login.e_confrim')}}</button>

			<view class="mt30">
					 <view>{{ $t('assets.remarks') }}:</view>
					 <view class="mt20">1.{{ $t('home.beizhu1') }}</view>
					 <view class="mt10">2.{{ $t('home.beizhu2') }}</view>
					 <view class="mt10">3.{{ $t('home.beizhu3') }}</view>
				</view>
		</view>
	</view>
</template>
