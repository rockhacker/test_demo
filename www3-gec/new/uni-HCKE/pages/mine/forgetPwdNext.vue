	...
	<view class="pt20 plr20" :class="{'light':theme=='light'}">
		<view class="mb10 mt30">
			<view class="flex bgwhite alcenter bdb_myblue ">
				...
				<input type="text" v-model="password" @input="passwordInput1" class="h40 lh40 flex1" v-if="showPassA == true"  :placeholder="$t('login').p_pwd"/>
				<input type="text" password="" v-model="password" @input="passwordInput1" class="h40 lh40 flex1" v-else  :placeholder="$t('login').p_pwd" />
		...
		<view class="mb10">
			<view class="flex bgwhite alcenter bdb_myblue ">
				...
				<image src="/static/image/password.png" class="wt15 h15 ml10"></image> -->
				<input type="text" v-model="re_password" @input="passwordInput2" class="h40 lh40 flex1" v-if="showPassB == true"  :placeholder="$t('login').p_confirmPwd"/>
				<input type="text" password="" v-model="re_password" @input="passwordInput2"  class="h40 lh40 flex1" v-else  :placeholder="$t('login').p_confirmPwd" />
