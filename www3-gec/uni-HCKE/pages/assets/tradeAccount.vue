<template>
	<view :class="theme">
		...
		<view class="px-20 pt-30 pb-140 mt-20" style="min-height: calc(100vh - 100px);">
		...
		<view class="fixed w-full flex items-center bottom-0 bg-my-gray border-0 border-t-2 border-solid border-gray-100 dark:border-gray-900">
			<!-- 币币账户 -->
