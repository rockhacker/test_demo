  ...
  <view class="home" :class="theme">
	  <view>
		...
		<view class="mx-30 bg-my-gray rounded-xl mt-30 pt-40 pb-20 flex flex-wrap">
			<view class="flex flex-col items-center mb-20" style="width:25%" @click="toPath('/pages/home/wdtg')">
				<image class="w-100 h-100 mb-20" src="/static/image/icon_yqjl.png"></image>
				<text class="text-center">{{$t('assets.yqjl')}}</text>
			</view>
			...
			<view class="flex flex-col items-center" style="width:25%" @click="toPath('/pages/financial/financial')">
				<image class="w-100 h-100 mb-20" src="/static/image/icon_lc.png"></image>
				<text class="text-center">{{$t('assets.lc')}}</text>
			</view>
			...
			<view class="flex flex-col items-center" style="width:25%" @click="toPath('/pages/home/chat')">
		...
		<view class="flex m-30">
			<view @click="toPath('/pages/home/recharge')" class="flex w-350 h-200 bg-contain items-center pl-30 pr-40 bg-no-repeat" style="background:url(./static/image/bg_kscz.png)">
				...
				<image class="w-160 h-180" src="/static/image/icon_kscz.png"></image>
			</view>
			<view @click="toPath('/pages/mine/withdraw')" class="flex w-350 h-200 bg-contain items-center pl-50 pr-20 bg-no-repeat" style="background:url(./static/image/bg_kstb.png)">
				...
				<image class="w-160 h-180" src="/static/image/icon_kstb.png"></image>
			</view>
		</view>
...
export default {
	...
	methods: {
		...
		toPath(url){
			if(url=='/pages/contract/lever' || url=='/pages/assets/assets' || url=='/pages/financial/financial'){
