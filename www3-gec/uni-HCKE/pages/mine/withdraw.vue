<template>
	<view :class="theme">
		<view class="min-h-screen p-30">
			<view class="flex items-center justify-between p-30 bg-my-gray rounded-lg mb-30" v-for="(item,index) in coinList" :key="index" @click="toUrl(item)"  v-if="item.currency.open_draw==1">
