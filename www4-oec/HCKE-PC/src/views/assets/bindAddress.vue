    ...
    <div class="mt20 plr30">
      <div class="flex alcenter mb20">
        <div class="flex alcenter flex1">
          ...
          <el-select v-model="currencyCode" class="flex1 selectBor bdinput" @change="changeCurrency" placeholder="">
        ...
        <div class="flex alcenter flex1 ml30" v-if="currencyProtocols.length > 1">
          ...
          <el-select v-model="currencyProtocolsCode" class="flex1 selectBor bdinput" @change="changeProtocols" placeholder="">
            <el-option
      ...
      <div class="flex alcenter flex1 mb20">
        ...
        <input type="text" v-model="address" class="ht40 lh40 plr20 bdinput flex1 baselight2" />
      </div>
      <!-- <div class="flex alcenter flex1 mb20">
      ...
      <div style="margin-left:100px;" class="mt30 radius2 ft16 tc ht48 lh48 white bgblue wt217" @click="bindAddress">{{$t('bind.bind')}}</div>
    </div>
  </div>
</template>
<script>
