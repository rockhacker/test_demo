      ...
      <div class="flex mt30">
        ...
        <div class="flex">
          <div style="position: relative;">
            <div class="flex alcenter" style="position: relative;    padding-left: 30px;">
              <div class="pr10" style="position: absolute;left:10px">{{$t('assets.from')}}</div>
              <el-select v-model="fromtype" class="" @change="changetransfer1" placeholder="">
                <el-option
          ...
          <div class="pl10" style="position: relative;">
            <div class="flex alcenter" style="position: relative;    padding-left: 30px;">
              ...
              <el-select v-model="totype" class="" @change="changetransfer2" placeholder="">
                <el-option
                  v-for="item in accoutlist"
                  :key="item.account_code"
                  :label="item.name"
