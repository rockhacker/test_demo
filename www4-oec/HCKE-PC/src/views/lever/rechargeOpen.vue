	...
	<div class="rechargeOpen ">
         <div class="open-header f-item">
            ...
            ></vue-qr>
              ...
              <button class="qr-btn" @click="setCopy">{{$t('feed.copyadd')}}</button>
         </div>
         <div v-if="false" class="open-form">
        ...
        <div v-if="false" class="footer">
            <button class="sub-btn" @click="submit">{{$t('feed.submit_transaction_screenshot')}}</button>
        </div>

        <div  class="open-header f-item mt20">
			<!-- <div class="mb-10">
			...
			<div class="mb-10 text-sm">
				<span>{{ $t('assets.c_tip2_1') }}</span>
				<span>{{ obj.currency_code || '--' }} </span>
				<span>{{ $t('assets.c_tip2_2') }}，</span>
				<span>{{ $t('assets.c_tip2_3') }}。</span>
			</div>
			<div class="mb-10 text-sm">
				<span>{{ obj.currency_code || '--' }} </span>
				<span>{{ $t('assets.c_tip3') }}。</span>
			</div>
			<div class="mb-10 text-sm">{{ $t('assets.c_tip4') }}。</div>
			<!-- <div class="mb-10 text-sm">
				<span class="ft12">{{ $t('assets.c_tip5') }}：</span>
				<span class="mainnum ft12">{{ coinInfo.min_number || '--' }}</span>
				<span class="ft12">{{ currencyName || '--' }}</span>
				,
			</div> -->
			<!-- <div class="mb-10 ft12">{{ $t('assets.c_tip6') }}。</div> -->
			<div class="mb-10 text-sm">{{ $t('assets.c_tip7') }}。</div>
			<div class="mb-10 text-sm">{{ $t('assets.c_tip8') }}。</div>
		</div>
