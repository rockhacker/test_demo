<template>
  <div class="account-main pb20">
    <div class="clear mb50">
      ...
      <div class="fl ml30">
        <div class="ft16 baselight flex between">
    ...
    <ul>
      ...
      <li>
        ...
        <span class="fr base ml25 mouseDefault"></span>
        <span class="fr base mouseDefault pointer" id="copy4" @click="copy4">{{$t('authentication.copy')}}</span>
      </li>
    </ul>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    copy4() {
      var that = this;
      var loc = location.origin;
      var clipboard = new Clipboard("#copy4", {
        text: function() {
          return that.uid;
        }
      });
