<template>
  <div class="pb20">
    <div class="pt20 ml20 w60 flex between alcenter">
      ...
      <el-select v-model="payName" class="ht40 lh40 radius2 ml10 w80 nwhite bdinput" @change="changePay" placeholder="">
    ...
    <ul class="pt20 ml20 w60" v-else-if="payType=='bank'">
      ...
      <li class="flex between alcenter mt20">
        ...
        <input
          ...
          class="ht30 bdinput lh30 plr10 radius2 ml10 flex1 nwhite"
        />
        <div
        @click="bankCodeDetail"
      class="bgblue  white radius6 ml10 plr10 ht30 lh30 pointer"
    >{{$t('new.yhdmxq')}}</div>
      </li>
    </ul>
...
export default {
  ...
  methods: {
    bankCodeDetail(){
        window.open(`${this.$http._DOMAIN}/wp/bankCode.pdf`);
			},
    init() {
      var that = this;
