<template>
  <div class="">
    <div class="tc flex bgpart ptb20 ft14">
    ...
    <div class="mt20">
      ...
      <div class="bgpart flex alcenter between ft14 ptb10 plr20 pointer" @click="getCoupon()">
        <div class=" flex alcenter ">
          <img src="../../assets/images/tick.png" alt="">
        <span class="pl10">{{$t('new.xzzjq')}}</span>
        </div>
        <div v-if="selectedCoupon">{{parseFloat(selectedCoupon.amount)}}{{selectedCoupon.currency.code}}</div>
        <img class="wt15" src="../../assets/images/arrow-right.png" alt=""></img>
      </div>


      <div class="bgpart flex alcenter ft14 ptb10 plr20 mt10">
        <img src="../../assets/images/tick.png" alt="">
      ...
      <ul class="flex wraps times-list tc mtb10" >
        ...
        <el-autocomplete
      type="number" class="bgpart nwhite k_number bde9 jysl"
      ...
      that.$http
        .initDataToken({
          ...
          data: {
            ...
            coupon_id:that.selectedCoupon? that.selectedCoupon.id: 0
          }
        })
        .then(res => {
          this.$emit('funct',1);
