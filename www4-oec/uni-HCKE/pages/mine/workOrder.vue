<template>
	<view :class="theme">
		...
		<view class="plr15 pt50">
			...
			<view class="ptb10 ft13">{{$t('feed.titel')}}</view>
			...
			<view class="mt-100 mb-60 bg-primary rounded-10 p-20 text-black text-lg text-center" @click="confirm" hover-class="opacity-50">{{$t('login.e_confrim')}}</view>
		</view>
	</view>
</template>
