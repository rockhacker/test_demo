<template>
  <div style="background-color: #0B1520;">
    <div class="w60 mauto ptb40">
      ...
      <div class="tc mt30 text-96A1C2">
        <p class="ft18 bold">TEST</p>
        <p class="ft12">
...
export default {
    ...
    methods:{
		toPath(){
			...
			window.open('https://api.TESTltd.com/wp/TEST.html');
		},
		toPathPDF(urls){
      ...
      govideo(){
        window.open('https://api.TESTltd.com/wp/TEST.mp4')
      },
		getList1() {
