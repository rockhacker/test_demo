      ...
      <div v-for="(item,i) in coinlist" :key="i">
        <div class="flex alcenter ptb10 bdbheader plr20">
          ...
          <div class="flex1 tr baselight2" v-if="changeData.is_recharge==1">
            ...
            <el-button class="bg-main-liner white" style="padding: 6px 16px" size="mini" @click="showInfo(item,i,'mention')" :disabled="!(item.currency&&item.currency.open_draw==1)">{{$t('assets.mention')}}</el-button>
            <!-- <span
              class="pointer"
