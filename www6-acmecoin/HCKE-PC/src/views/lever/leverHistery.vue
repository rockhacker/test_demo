<template>
  <div>
    <div class="flex bgwhite dark-bg-1C2532 ht40 lh40 baselight2 ft16">
      ...
      <div class="plr40 pointer" :class="types==5?'active2px':''" @click="changeType(5)">{{$t('lever.current')}}</div>
      <div class="plr40 pointer" :class="types==1?'active2px':''" @click="changeType(1)">{{$t('lever.allPosition')}}</div>
      <div class="plr40 pointer" :class="types==0?'active2px':''" @click="changeType(0)">{{$t('lever.allWei')}}</div>
      <div class="plr40 pointer" :class="types==3?'active2px':''" @click="changeType(3)">{{$t('lever.allClose')}}</div>
      <div class="plr40 pointer" :class="types==4?'active2px':''" @click="changeType(4)">{{$t('lever.allBack')}}</div>
    </div>
