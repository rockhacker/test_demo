        ...
        <div class="bgwhite dark-bg-111727 optionct">
            <div class="cont">
                 ...
                 <div class="tab-content conbg">
                       ...
                       <div class="tab-cont bg-F3F3F3 dark-bg-111727">
                             <div class="tab-header white">
                                    <div class="header-item mr30 flex column" :class="isTitle==0?'text-clip-green':'text-gray1'" @click="isTitle=0">
                                        <div>{{$t('new.pastres')}}</div>
                                        <div v-if="isTitle==0" class="bg-main-liner" style="height:3px;width:80px;margin-top: 6px;"></div>
                                    </div>
                                    <div class="header-item flex column" :class="isTitle==1?'text-clip-green':'text-gray1'" @click="()=>{isShow=true;isTitle=1}">
                             ...
                             <div class="period" v-show="isTitle==0">
                                    <div class="period-item text-gray1" v-for="(item,index) in historyLis" :key="index">
                       ...
                       <div class="qidetail bg-F3F3F3 dark-bg-111727">
                                ...
                                <div class="btn">
                                     <button v-if="token" class="zhang green" @click="submit(1)">{{$t('new.bullish')}}</button>
                 ...
                 <div class="list conbg">
                       <ul class="list-header dark-bg-111727">
                           <li>{{$t('new.cperiod')}}</li>
                           <li>{{$t('new.openam')}}</li>
                           <li>{{$t('new.orderst')}}</li>
                       ...
                       <ul class="list-content bdbheader dark-bg-111727" v-for="(item,index) in orderList" :key="index">
         ...
         .cont{
             ...
             .tabs{
                 ...
                 .tab-item{
                     ...
                     cursor: pointer;
                     &.active{
                         border-bottom: 4px solid #E5A013;
                         /* color:#E5A013; */
                     }
                     &:first-child{
                      margin-left:13px;
             ...
             .tab-content{
                 ...
                 .bgDetail{
                     ...
                     padding:0 10px;
                     height: 40px;
                     background: linear-gradient(90deg, #E4A013, #867C55, #2D5B93, #014AB2);
                     /* background: #E5A013; */
                     border-radius: 2px;
                     margin:15px 0 15px;
                     .text1{
