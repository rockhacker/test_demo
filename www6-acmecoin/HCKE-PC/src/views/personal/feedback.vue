<template>
  <div class="pb20">
    <div class="pt20 ml20 w60 flex between alcenter">
      ...
      <el-select v-model="typeName" class="ht40 lh40 radius2 ml10 w80 nwhite" @change="changePay" placeholder=""> 
    ...
    <ul class="pt20 ml20 w60">
      ...
      <li class="flex between alcenter mt20">
        ...
        <el-input type="textarea" :rows="6" class="w80 my-textarea ptb10" :placeholder="$t('feed.min_content')"  v-model="user_content"></el-input>
      </li>
      <li class="flex between alcenter mt20">
        <span></span>
        <div
        class="bg-main-liner w80 ht40 flex alcenter jscenter  white radius6 ft16 pointer"
