<template>
    <div class="flex alcenter jscenter register-page">
        <div class="bg-box radius4 plr60 ptb40 w25 mwidth" style="margin-top:80px;">
            <div class="tc ft20 white">{{$t('register.welcome')}}</div>
            <div class="mt40 ">
                <div class="flex alcenter bold">
                    <div class="pb10 mr20 pointer" v-show="i!=0" :class="{'active2px':index==i}" v-for="(item,i) in infos" :key="i" @click='changeMethod(i)'>{{$t(item)}}</div>
                </div>
                <div class="mt20 border-b-EEEEEE ht50 lh50 flex alcenter">
                    <!-- <div class="w20 bdr tc">+86</div> -->
                    <el-select v-if="index==0" filterable v-model="country_code"  class="w25" @change='changeCountry'>
                        <el-option
                    ...
                    <input type="text" class="flex1 h100  pl20 white" v-model="account" @change="changeAccount" :placeholder="index == 0 ? $t('register.enterPhone') : $t('register.enterEmail')">
                </div>
                <!-- <p class="mt20">
                ...
                <div class="mt20 border-b-EEEEEE ht50 lh50 flex alcenter">
                    <input type="password" class="flex1 h100  pl20 white" v-model="password" :placeholder="$t('register.enterPassword')">
                </div>
                <div class="mt20 border-b-EEEEEE ht50 lh50 flex alcenter">
                    <input type="password" class="flex1 h100  pl20 white" v-model="re_password" :placeholder="$t('register.enterPassword2')">
                </div>
                <div class="mt20 border-b-EEEEEE ht50 lh50 flex alcenter">
                    <input type="text" class="flex1 h100  pl20 white" v-model="invite_code" :placeholder="$t('register.invitationCode')">
                </div>
                <template v-if="is_quick_register">
                    <div class="mt20 border-b-EEEEEE ht50 lh50 flex alcenter">
                    <input type="text" class="flex1 h100  pl20 white" v-model="realName" :placeholder="$t('collect.pleaseenteraname')">
                    </div>
                    <div class="mt20 border-b-EEEEEE ht50 lh50 flex alcenter">
                        <input type="text" class="flex1 h100  pl20 white" v-model="idaccount" :placeholder="$t('collect.p_cardno')">
                    </div>
