                ...
                <div class="bgwhite dark-bg-1C2532 flex alcenter plr10 ht40">
                    ...
                    <el-popover
                        ...
                        <div>
                              <div  class="flex alcenter plr10">
                                <div class="plr5 ht25 lh25 tc ft12 baselight2 radius2 mr10 pointer" v-for="(item,i) in tradeList" :key="item.id" :class="{'bgblue txtwhite':currentIndex==i}" @click="$emit('changelegal',i)" >{{item.code}}</div>
                            </div>
                             <div class="flex alcenter mt10 mb10 white" >
                    ...
                    <div v-if="tradeList.length>0 && tradeList[currentIndex]">
                        <div class="flex alcenter ptb5 markethover pointer" :class="{'bgshadow':itm.symbol==symbol}"  v-for="(itm,j) in tradeList[currentIndex].matches" v-if="itm.open_change==1"  :key="j" @click="$emit('changeSymbol',j)">
							...
							<div v-if="itm.base_currency_code=='ETHFX' && !isOnline(itm.market_time)" class="mlr10">{{$t('trade.soon')}}</div>
							<template v-else >
			...
			<div class="bgwhite dark-bg-1C2532" style="width:290px;height:100%">
                ...
                <div class="flex mlr10 pointer" style="border-radius:2px;overflow: hidden;">
                    <!-- <el-button-group class="flex1">
                        ...
                        <div class="flex1 posRelt bg-k-green" @click="markType=0" style="height:34px;text-align: center;line-height: 34px;color:#fff;font-size:16px">{{$t('trade.buy')}}
                        ...
                        <div class="flex1 posRelt bg-k-red" @click="markType=1" style="height:34px;text-align: center;line-height: 34px;color:#fff;font-size:16px">{{$t('trade.sell')}}
                ...
                <div class=" flex  ft12">
                    ...
                    <div class="flex1 plr10 mt10 bdr38" v-show="markType==0">
                        ...
                        <div class="flex alcenter mb10 posRelt">
                            ...
                            <input type="text" v-model="buyprice" class="ht30 bdinput lh30 plr5 radius2 ml10 flex1 nwhite" v-show="index==0" @input='buypriceInput' @keyup='buypriceInputKeyDown($event)'>
                        ...
                        <div class="bg-k-green tc ht30 lh30 white radius2 pointer" style="height: 34px;line-height: 34px;font-size: 16px;" @click="buyin" v-else>{{$t('trade.buy')}}</div>
                    </div>
                    <!-- 卖盘 -->
                    <div class="flex1 plr10 mt10" v-show="markType==1">
                        ...
                        <div class="bg-k-red tc ht30 lh30 white radius2 pointer" style="height: 34px;line-height: 34px;font-size: 16px;" @click="sellout" v-else>{{$t('trade.sell')}}</div>
                    </div>
                </div>
            </div>
		</template>
