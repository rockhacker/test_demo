	...
	<view :class="theme">
		...
		<view class="py-20 bg-white dark:bg-box">
			...
			<view class="px-30 py-20 mt-20">
				<view class="bg-primary text-white rounded-10 p-30 text-lg text-center" @tap="transfer" hover-class="opacity-50">{{ $t('assets.transfer') }}</view>
			</view>
		</view>
		
		<view class="py-30 mt-20 bg-white dark:bg-box" style="min-height:50vh">
