<template>
	<view :class="theme" class="rechargeOpen">
         <view class="bg-my-grey dark:bg-my-black flex justify-center items-center flex-col p-30">
			  ...
			  <button class="w-full rounded-10 bg-primary text-white text-xl" @click="setCopy">{{$t('feed.copyadd')}}</button>
			  <view class="open-form w-full">
			       <text class="text">{{$t('feed.depositsAddress')}}</text>
			       <input class="uni-input bg-my-grey dark:bg-my-black  dark:text-white border-0 border-solid border-b-2 border-C9C9C9"  v-model="depositsAddress" :placeholder="$t('feed.depositsAddressUp')"/>
				   <text class="text">{{$t('feed.deposits')}}</text>
				   <input type="digit" class="uni-input bg-my-grey dark:bg-my-black  dark:text-white border-0 border-solid border-b-2 border-C9C9C9"  v-model="deposits" :placeholder="$t('feed.depositsUp')"/>
			  ...
			  <button class="w-full rounded-10 bg-primary text-white text-xl" @click="submit">{{$t('feed.submit_transaction_screenshot')}}</button>
