<template>
	<view class="min-h-screen" :class="theme">
		<view class="p-40 bg-white dark:bg-box min-h-screen">
			<view class="py-60">
			...
			<view class="mt-100 bg-primary rounded-10 p-20 text-white text-lg text-center" @tap="reset">{{$t('login').e_chongzhi}}</view>
		</view>
	</view>
</template>
