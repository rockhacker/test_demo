<template>
  <view class="min-h-screen" :class="theme">
	<view class="min-h-screen bg-white dark:bg-box">
      ...
      <view class="flex bgwhite items-center mt-20 border-0 border-b-2 border-solid border-gray-200 dark:border-gray1">
