<template>
	<view :class="theme">
		<view class="p-30 bg-white dark:bg-my-black">
			<view class="flex items-center justify-between bg-box rounded-10">
				<view class="flex items-center flex-1">
					<view class="flex flex-col items-center px-30">
						<text class="w-10 h-10 rounded-half bg-primary"></text>
		...
		<view class="py-20 bg-white dark:bg-box">
			...
			<view class="px-30 py-20 mt-20">
				<view class="bg-primary text-white p-20 text-lg text-center" style="border-radius: 100rpx;" @tap="transfer" hover-class="opacity-50">{{ $t('assets.transfer') }}</view>
			</view>
		</view>
		
		<view class="py-30 mt-20 bg-white dark:bg-box text-gray1" style="min-height:50vh">
			<view class="px-30 text-xl">{{ $t('assets.transferlog') }}</view>
			<view>
				<view class="p-30 flex items-center border-0 border-b-2 border-solid border-gray-200 dark:border-gray1">
