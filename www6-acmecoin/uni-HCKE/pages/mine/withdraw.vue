<template>
	<view :class="theme">
		<view class="min-h-screen text-black dark:text-white bg-white dark:bg-my-black">
			<view class="flex items-center justify-between p-30 border-0 border-b-2 border-solid border-gray-100 dark:border-gray-900 dark:bg-box" v-for="(item,index) in coinList" :key="index" @click="toUrl(item)"  v-if="item.currency.open_draw==1">
