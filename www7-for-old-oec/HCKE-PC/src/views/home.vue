<template>
  <div class="home">
    ...
    <div class="new-balck2 ptb60">
      ...
      @click="toUrl(item)"
		  >
			<div class="flex alcenter between w100">
			  <div class="ft20 flex white alcenter">
          <img class="wt30 radius50p mlr10" :src="item.base_currency.logo" alt="" srcset=""></img>
			...
			<div class="c-pd">
			  <div
				class="pl5 ft16 white pt10 ml10 mb10"
      ...
      <div class="flex jsend flexend w100">
        <span
			  class="ft14 white radius8 plr10 ptb5"
			  :class="{
  ...
  <div class="new-balck2">
    <div class="wt1200 mauto">
      <div class="flex ht30 alcenter white marketRackHeaders">
      ...
      <div class="flex pb20 white hover-item marketRack" v-for="(item,index) in marketlist" :key="index"  >
  ...
  <div class="new-balck2 ptb40">
    <div class="wt1300 mauto flex alcenter pb20">
      <div class="white mr40">
  ...
  <div class="new-balck3 white ptb30">
  ...
  <div class="new-balck2 ptb40 flex column jscenter alcenter">
    <div class="wt1300  white flex alcenter">
        <div class="flex1">
    ...
    <div class="wt1300  white flex alcenter between flexend mt40">
      <div>
