<template>
    <div class="flex alcenter jscenter mt20">
        <div class="bgpart radius4 plr60 ptb40 mb50 w25 mwidth">
            ...
            <div class="mt40 ">
                <div class="bdbea2 flex alcenter bold">
                    <div v-show="i==1" class="pb10 mr20 pointer" :class="{'active2px':index==i}" v-for="(item,i) in infos" :key="i" @click='changeMethod(i)'>{{$t(item)}}</div>
                </div>
                <div class="mt20 bde7 radius2 ht50 lh50 flex alcenter">
                    <!-- <div class="w20 bdr tc">+86</div> -->
                    <el-select v-if="index==0" v-model="country_code"  class="w25" @change='changeCountry'>
                        <el-option
                ...
                <template v-if="is_quick_register">
                    <div class="mt20 bde7 radius2 ht50 lh50 flex alcenter">
                    <input type="text" class="flex1 h100 bdle7 pl20 nwhite" v-model="realName" :placeholder="$t('collect.pleaseenteraname')">
                    </div>
                    <div class="mt20 bde7 radius2 ht50 lh50 flex alcenter">
                        <input type="text" class="flex1 h100 bdle7 pl20 nwhite" v-model="idaccount" :placeholder="$t('collect.p_cardno')">
                    </div>
        ...
        sendcode(){
            ...
            if(this.index==0){
                ...
                this.$http.initDataToken({url:'notify/send_sms',type:'POST',data:{
                    to:`${this.getCountryCode}${this.account}`,
                    type:1,
