<template>
	<div class="minh100 ft16">
		<div class="mauto wt1200 ptb20">
			...
			<el-card class="box-card mb20 ft20">
				<div class="ft18 mlr20 mtb20 bgf6 plr70 ptb30 radius10">
					...
					<div class="flex mauto ptb50">
						...
						<div class="flex1 bdbea2">
							<input type="number" :placeholder="$t('subscription.qsrje')" class="w100 h100 ft18 plr20 black" v-model="amount">
						</div>
						
					</div>
					<el-button type="warning" class="w100 mb50" @click="submit">{{$t('subscription.lijishenggou')}}</el-button>
					
					<div v-if="subscription.currency && subscription.currency.desc" class="mb50">
						<div class="ft16 black mb20">{{$t('subscription.bizhongjieshao')}}</div>
