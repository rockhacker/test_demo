<template>
	<view :class="theme">
		...
		<view class="mt-20 bg-white dark:bg-floor p-30 text-center">
			...
			<view class="mt-20 mx-auto w-160 h-60 rounded-10 flex justify-center items-center bg-primary" @tap="fuzhi_invite">{{ $t('assets.coypaddr') }}</view>
		</view>
		<view class="bg-white dark:bg-floor p-30 text-warn">
			<!-- <view class="mb-10">
