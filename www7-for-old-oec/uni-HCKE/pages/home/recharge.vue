<template>
	...
	<view :class="theme">
		...
		<!-- <view class="recharge-header">
         ...
         <view class="min-h-screen text-black dark:text-white bg-white dark:bg-gray-900">
			<view class="flex items-center justify-between p-30 border-0 border-b-2 border-solid border-gray-100 dark:border-gray-900 bg-white dark:bg-floor" @click="detail(item)" v-for="(item,index) in wallet_data" :key="index">
				 <view class="flex items-center">
					<image :src="host+item.currency.logo" class="w-60 h-60"></image>
					<view class="ml-20 text-lg">{{item.currency_code_protocol}}</view>
				 </view>
		...
		<!-- <navigator class="recharge-content text-danger" url="/pages/home/chat">
		  <view class="left">
