  ...
  <div class="mr25 white pointer flex alcenter" :class="{'routeractive':selectB!=''}" slot="reference">
    ...
    <img class="pl10"  :class="{'rotate':show2}" src="./assets/images/arrow-dowm.png" alt="" srcset="">
      ...
      <div class="flex alcenter between">
        ...
        <router-link
          :to="{ name: 'register' }"
          class="ml10 plr20 radius2  login-btn bg-main-liner black"
          v-show="!account"
...
export default {
  ...
  async created() {
    ...
    let theme = 'dark' ||localStorage.getItem('theme') || 'light';
...
.el-switch.is-checked .el-switch__core{
  ...
  border-color:#3DEBA1 !important;
}
.el-loading-spinner i {
    color:#3DEBA1 !important;
}
...
.el-button:focus, .el-button:hover{
	color: white;
  border-color: #2FA079 !important;
  background-color: #2FA079 !important;
	/* border-color: #3DEBA1; */
	/* background-color: #f7f3e2; */
}
.el-dropdown-menu__item:focus, .el-dropdown-menu__item:not(.is-disabled):hover{
	background-color: #3DEBA1;
	color: #000;
}
