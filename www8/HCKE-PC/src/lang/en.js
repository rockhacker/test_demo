export default {
    ...
    zhang: "a sheet",
		...
		"tiaokuan": "this look",
		"jrwm": "Join us",
		"fk": "World top security risk control system",
		"fksm": "Offline storage, multiple factors and means, 7 days, 24 hours, no rest all year round, podium with control, all-round protection of user assets",
		"cbj": "Safety reserve",
		"wsg": "No accident in 3 years",
		"djaq": "Top safety risk control",
		"jgxk": "With management authorization",
		"jgjs": "Test is a financial currency comparison service station registered and operated in compliance with the law under the supervision of FinCEN (financial institution crime detection Bureau under the US Department of Finance), fintrac (Canadian financial transaction and report analysis center) and sec (US Securities and Exchange Commission). Test will comply with all applicable laws and technical regulations of each jurisdiction where it operates according to its financial license.",
		"meiguo": "U.S.A",
		"jianada": "Canada",
		"jgz": "With the tube",
		"jgzh": "With the certificate number",
		"fzrq": "Date of issue:",
		"mgyzwz": "Us Veritas website",
