<template>
    <div class="flex alcenter jscenter  minvh100 f-item login-page">
        <div class="bgwhite radius4 plr60 ptb40 mb50 w25 mwidth">
            <div class="tc ft20 text-333333">{{$t('login.welcome')}}</div>
            <div class="mt40 ">
                <div class="bold">
                    <span class="mr20 ft14" style="border-bottom:2px solid #2FA079" :class="{'active2px':index==i}" v-for="(item,i) in infos" :key="i"><span class="text-clip-green">{{$t(item)}}</span></span>
                </div> 
                ...
                <div class="flex between alcenter mt10">
                    <p class="flex alcenter">
						...
						<el-checkbox v-model="remember" text-color="#fff" fill="#3DEBA1">{{$t('login.rem_pwd')}}</el-checkbox>
                    </p>
