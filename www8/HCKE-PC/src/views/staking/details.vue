						...
						<div class="flex1 ml20">
							 <div class="text-333333 dark-text-white bold mb30">{{staking.title}}</div>
							  <div class="flex flexend">
								...
								<el-tag size="mini" class="bg-main-liner white">{{$t('staking.meiqipaixi')}} {{staking.dividend_percentage}}%</el-tag>
							 </div>
						 </div>
					</div>
				</div>
							...
							<!-- <div class="flex alcenter between mb30">
							 ...
							 <div class="flex mb60">
								<el-input v-model="amount" type="number" class="wt340 bgwhite dark-text-white dark-bg-1C2532">
									<template slot="append"><el-button class="wt100 ml20 bg-main-liner white" style="border-radius: 0;" @click="buyProduct">{{$t('staking.shengou')}}</el-button></template>
								</el-input>
							 </div>
