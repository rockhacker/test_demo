<template>
	<div class="minh100 ft16">
			...
			<div class="mauto wt1200 ptb20">
				<div class="flex between">
					<div class="flex1">
						...
						<div class="flex text-clip-green mt20 between">
		...
		<div class="mauto pt20 wt1200 pb80">
			<el-card class="ft18 mb20 text-333333 dark-text-white f-item">
				...
				<div class="flex between plr10 ptb10">
					 ...
					 <div class="flex1 flex column between">
						 <div class="flex jsend">
							<el-button class="mr10 bg-main-liner white" style="border-radius: 0;" @click="$router.push({path:`/stakingDetails?id=${item.id}`})">{{$t('staking.shengou')}}</el-button>
						 </div>
