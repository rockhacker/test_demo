		...
		<view class="text-333333 dark:text-white bg-my-grey dark:bg-my-black">
			...
			<uni-nav-bar fixed>
				<scroll-view  class="scroll-view_H h-100 leading-100" scroll-x="true" scroll-with-animation :scroll-left="scrollLeft">
					<view class="tab-scroll_item scroll-view-item_H  h-60 rounded-10" :class="{'bg-main-linear text-black dark:text-white':index==tabIndex,'text-333333 dark:text-999FAA':index!=tabIndex}" hover-class="opacity-50"
