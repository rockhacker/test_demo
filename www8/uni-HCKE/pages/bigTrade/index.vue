<template>
	<view :class="theme">
		<view class="text-black dark:text-white">
			<view class="w-full flex flex-col py-20 px-40 border-0 border-solid border-b-2 border-gray-100 bg-white dark:bg-my-black">
			...
			<view v-if="!soon" class="min-h-screen bg-gray-100 dark:bg-my-black">
				<!-- <view class="flex justify-center items-center text-3xl h-600" v-if="soon">{{$t('trade.soon')}}</view> -->
				...
				<!-- 当前委托列表 -->
				<view class="mt-20 p-20 bg-white dark:bg-my-black pb-120 min-h-half">
					<view class="flex justify-between">
