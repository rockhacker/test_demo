<template>
    <view :class="theme">
        <view class="recharge pb-20">
            ...
            <view class="recharge-content new-bg">
                <view class="title dark:text-999FAA">{{$t('feed.following')}}</view>
                <view class="items">
            ...
            <view class="footer">
                    <view class="f-logo new-bg" @click="recharge('https://banxa.com/')">
                        <view class="fast">
                            <image class="logos" src="/static/image/banxa-logo.svg" ></image>
                        </view>
                        <view class="texts text-clip-green">{{$t('new.hez')}}</view>
                    </view>
                    <view class="f-logo new-bg" @click="recharge('https://c2c.binance.com/en/?fiat=USD')">
                        <view class="fast">
                ...
                <view class="f-logo new-bg" @click="recharge('https://www.coinbase.com')" >
                        <view class="fast">
                            <image class="logos"   src="/static/image/ppp.svg" ></image>
                        </view>
                        <view class="texts text-clip-green">{{$t('new.hez')}}</view>
                </view>
                <view class="f-logo new-bg" @click="recharge('https://crypto.com/')" >
                        <view class="fast">
                            <image class="logos"   src="/static/image/crypto-blue.jpg" ></image>
                        </view>
                        <view class="texts text-clip-green">{{$t('new.hez')}}</view>
                </view>
                <view class="f-logo new-bg" @click="recharge('https://kraken.com/')" >
                    <view class="fast">
                                        <image class="logos"   src="/static/image/kraken1.jpg" ></image>
                                    </view>
                        <view class="texts text-clip-green">{{$t('new.hez')}}</view>
                </view>
                <view class="f-logo new-bg" @click="recharge('https://www.bitbank.com/')" >
                    <view class="fast">
                                        <image class="logos"   src="/static/image/bitbank.png" ></image>
                                    </view>
                        <view class="texts text-clip-green">{{$t('new.hez')}}</view>
                </view>
                <view class="f-logo new-bg" @click="recharge('https://www.kucoin.com/assets/payments?lang=en_US')" >
                        <view class="fast">
                            <image class="logos"   src="/static/image/ppppp.png" ></image>
                        </view>
                        <view class="texts text-clip-green">{{$t('new.hez')}}</view>
                </view>
                <!-- <view class="f-logo new-bg" @click="recharge('https://www.bitflyer.com')" >
                        <view class="fast">
            ...
            <!-- <navigator class="recharge-content new-bg dark:text-white" url="/pages/home/chat">
            <view class="left">
