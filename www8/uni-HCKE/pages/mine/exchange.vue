<template>
	<view  :class="theme">
	     <view class="bgPart px-30 bg-white dark:bg-1C2532 min-h-screen text-white">
               <view class="flex py-40" v-if="show==1">
                     <view class="flex-1 bg-gray-100 dark:bg-333F4A w-full h-80 flex justify-center items-center">
               ...
               <button class="w-full rounded-10 bg-main-linear text-black text-xl mt-100" @click="sub">{{$t('new.duih')}}</button>
         </view>
	</view>
</template>
