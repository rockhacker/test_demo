  ...
  <view :class="theme">
	  <view class="bg-my-grey dark:bg-1C2532 text-black dark:text-white" style="min-height: 100vh;">
		  <view class="p-40 flex justify-between">
			<image src="../../static/image/wewe.png" mode="widthFix" class="w-60 h-60"></image>
		...
		<view class="p-40">
			...
			<view class="py-40">
				...
				<view class="my-60 bg-main-linear rounded-10 p-20 text-black text-lg text-center" @tap="login" hover-class="opacity-50">{{ $t("login").login }}</view>
				<view class="my-60 bg-main-linear rounded-10 p-20 text-black text-lg text-center mt-30" @tap="toWallet" hover-class="opacity-50">{{ $t("wallet.login") }}</view>
			</view>
