<template>
  <view class="min-h-screen" :class="theme">
	<view class="min-h-screen bg-white dark:bg-1C2532 text-white">
      ...
      <!-- <view class="w48 ptb5 plr5 rounded-8 text-center mb10" @tap="uploadImg(3)">
			...
			<view class="mt-100 h-80 flex justify-center items-center text-center bg-main-linear text-black text-lg rounded-10" @tap="confirm">{{ $t("login.e_confrim") }}</view>
    </view>
