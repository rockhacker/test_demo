			...
			<view class="mt40 ">
				<view class="mb10 ">
					...
					<view class="flex bgwhite alcenter bdb_myblue ">
						...
						<button size="mini" type="primary" class="px-40 bg-main-linear text-black"  :disabled="disable" :loading="load" @click="send">{{ codeText }}</button>
					</view>
					<view class="flex bgwhite alcenter bdb_myblue ">
					...
					<view class="mt45 radius4 ptb10 ft14 tc mb10 bg-main-linear text-black" @tap="register">{{$t('login.register')}}</view>
				</view>
			</view>
