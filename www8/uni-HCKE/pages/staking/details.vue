<template>
	<view :class="theme">
		<view class="text-black dark:text-white bg-white  text-white dark:bg-101625 w-full min-h-screen flex flex-col">
			...
			<view class="flex p-30">
				...
				<view class="flex-1 ml-40">
					...
					<view class="flex items-end">
						...
						<view class="text-sm rounded-2xl px-10 py-6 bg-main-linear text-black" style="color: #e6a23c;">{{$t('staking.meiqipaixi')}} {{staking.dividend_percentage}}%</view>
					</view>
				</view>
			</view>
			<view class="mt-10 flex-1">
				...
				<view class="text-xl flex rounded-10">
					<view class="w-full flex justify-center p-40">
						<view class="w-full flex flex-col p-40 rounded-10 bg-gray-100 dark:bg-1A222B">
				...
				<!-- 			<view class="flex alcenter between mb30">
							...
							<view class="mt-20 rounded-3xl p-20 bg-main-linear text-black text-sm text-center  my-40" hover-class="opacity-50" @tap="buyProduct">{{ $t("staking.shengou") }}</view>
