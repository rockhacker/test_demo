<template>
	<view :class="theme">
		<view class="p-30 bg-my-grey dark:bg-my-black text-white">
			<view class="bg-white dark:bg-1C2532 p-20 mb-20 rounded-8">
				...
				<view class="mt-20 rounded-10 p-20 text-black text-sm text-center bg-main-linear my-40" @tap="submit">{{$t('subscription.lijishenggou')}}</view>
