export default {
	...
	collect:{
		...
		"upImg": "Please upload ID photos. The first one is the front, the second is the back, and the third is a hand-held ID photo",
		"ff": "Review rejection",
		"sl": "shooting example",
	...
	"add": {
		"jiaoyi": "transaction",
	"yhm": "User name registration",
	"login_yhm": "User name login",
	"playhm": "enter one user name",
	"plauser": "Please enter 6-16 digits, letters, or underscores",
	"guoj": "country",
	"p_guoj": "Please select a country",
	"zbjl": "Accounting change records",
	"jjdw": "Pricing method",
	"ksnd":"Start your cryptocurrency journey",
	"qq":"TEST, the world's largest cryptocurrency exchange platform, allows investors to conduct investment transactions safely and safely.",
	"yys":"Username/mobile phone/email",
	kkzs:'Open available',
	"tiaog": "skip",
	"qh_ss": "Area Code/Country",
	"zhzc": "Account registration",
	...
	"one": "Download Google Authenticator APP",
	"two": "Scan the QR code in the above image and input the verification code to complete the binding",
	"plats": "Please enter the verification code",
	"zccg": "login was successful",
	"kqnd": "Start Your Journey to Digital Currency",
	"wxy": "I want to buy coins",
	"xycz": "I want to recharge",
	"wty": "I have agreed to authorize the call to the system information notification permission",
	"wyty": "I have agreed to authorize access to the address book",
	"ggyzq": "Google Verifier",
	"sjyz": "Mobile verification",
	"yxyz": "Email verification",
	"ggyz": "Google Authenticator ",
	"ggtt": "The Google Authenticator app will protect your account and withdrawal functionality",
	"yxtt": "Email verification will protect your account and withdrawal function",
	"sjtt": "Mobile verification will protect your account and withdrawal function",
	"bdsj": "Please bind your phone for verification",
	"bdyx": "Please bind the email for verification",
	"bdgg": "Please bind to Google Authenticator",
	"quzyz": "Please select the verification method",
	"yyz": "Verified",
	"qyz": "To verify"
	}
}
