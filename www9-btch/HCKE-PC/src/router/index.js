...
import google from '@/views/personal/google'
import finish from '@/views/personal/finish'
import email from '@/views/personal/email'
import phone from '@/views/personal/phone'
