  ...
  <div class="home bgwhite">
    <div class="block myswiper">
      <!-- <el-carousel height="601px">
       ...
       <div class="flex pb80 pt80 wt1200 mauto bgwhite black">
          <div class="flex1" :class="lang">
              <h1 class="ft60 bold">{{$t('add.ksnd')}}</h1>
              <p class="pt40 ft20" style="width: 450px;">{{$t('add.qq')}}</p>
              <div class="flex pt30 input-btn items-center">
                 <input  type="text" :placeholder="$t('add.yys')" class="ft16">
                 <button class="btn ft18" @click="$router.push('/register')">{{$t('login.register')}}</button>
              </div>
          </div>
          <div class="flex1 flex jscenter">
            <img width="335px" height="379px"  src="../assets/images/b.png" alt="">
          </div>
       </div>
    </div>
    <div class="pb40 posRelt" style="z-index:999">
    ...
    <div class="bgwhite pt30 pb30 flex jscenter">
      <!-- <img style="height: auto;width: 500px;" src="../../static/imgs/pz.jpg" alt=""> -->
      <div>
        <div>
         <div class="flex alcenter jscenter">
        <img src="/static/imgs/green-line.png" alt="" srcset="">
	    ...
	    <div class="content mauto mt30 black" style="width:600px" v-html="$t('new.jiec')"></div>
    ...
    <div class="tc ht40 lh40  radius2 blue bg-main-liner ft16 mt20 pointer" @click="topo"> 
						<!-- <img  class="wt40" src="../assets/images/shu.png"/> -->
					<span class="ft18 white "><font>{{ $t("new.baipi") }}</font></span>
				</div>
      </div>
    </div>
    ...
    methods:{
      topo(){
        var lang = this.lang;
				 ...
				 console.log()
				window.open(`${this.$http._DOMAIN}/wp/TEST-en.pdf`);
		},
		getAnnouncement() {
			try {
				const that = this;
