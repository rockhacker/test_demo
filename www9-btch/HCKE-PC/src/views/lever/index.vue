          ...
          <div v-if="list.length > 0 && list[currentIndex]">
            ...
            >
              ...
              <div class="flex1 tr baselight2" v-if="itm.currency_quotation">
                <!-- {{ itm.base_currency_code=='blescoin'?!isOnline(itm.market_time)?$t('trade.soon'):itm.currency_quotation.close:itm.currency_quotation.close }} -->
              ...
              <div
                ...
                v-if="(itm.base_currency_code=='blescoin'?isOnline(itm.market_time):true) && itm.currency_quotation"
              >
...
export default {
  ...
  computed:{
	 ...
	 soon(){
		return this.currency_matchInfo.base_currency_code=='blescoin' && !this.isOnline(this.currency_matchInfo.market_time)
	 }
  },
  created() {
