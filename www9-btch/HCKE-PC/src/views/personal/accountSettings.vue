<template>
  <div class="account-main pb20">
    <div class="clear mb50">
      ...
      <div class="fl ml30">
        <div class="ft16 white flex between">
			<div class="flex alcenter baselight">
				{{$t('authentication.security')}}
				<span class="ml10">{{lever}}</span>
			</div>
			<div class="ft14 mr20">
				<div style="color:#ff9900" v-if="level">
					{{level}}
				</div>
				<div style="color:#ff9900" v-if="credit">
    ...
    <ul>
      ...
      <li >
        <img :src="bsrc" v-if="!obj.google_secret_verified" />
        <img :src="msrc" v-else />
        <span class="ml20">{{$t('add.ggyzq')}}</span>
        <p class="fl" v-if="obj.google_secret_verified">{{$t('add.yyz')}}</p>
        <span class="fr ml25 mouseDefault"></span>
        <router-link v-if="!obj.google_secret_verified" class="fr base mouseDefault" to="/google">{{$t('add.qyz')}}</router-link>
      </li>
       <li>
        <img :src="bsrc" v-if="!obj.mobile_verified" />
        <img :src="msrc" v-else />
        <span class="ml20">{{$t('add.sjyz')}}</span>
        <p class="fl"  v-if="obj.mobile_verified">{{$t('add.yyz')}}</p>
        <span class="fr ml25 mouseDefault"></span>
        <router-link   v-if="!obj.mobile_verified" class="fr base mouseDefault" to="/phone">{{$t('add.qyz')}}</router-link>
      </li>
      <li>
        <img :src="bsrc" v-if="!obj.email_verified" />
        <img :src="msrc" v-else />
        <span class="ml20">{{$t('add.yxyz')}}</span>
        <p class="fl" v-if="obj.email_verified">{{$t('add.yyz')}}</p>
        <span class="fr ml25 mouseDefault"></span>
        <router-link v-if="!obj.email_verified" class="fr base mouseDefault" to="/email">{{$t('add.qyz')}}</router-link>
      </li>
