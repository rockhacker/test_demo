      ...
      <div class="mt40">
       ...
       <!-- <p class="mt20">
        ...
        <div class="mt20 border-b-EEEEEE radius2 ht50 lh50 flex alcenter">
          ...
          <div class="w20 bdr tc text-clip-green pointer" @click="sendcode" v-show="!hassend">{{$t('login.r_send')}}</div>
        ...
        <div class="mt40 bg-main-liner white tc h48 lh48 radius2 pointer" @click="submsits">{{$t('login.e_confrim')}}</div>
      </div>
    </div>
  </div>
</template>
