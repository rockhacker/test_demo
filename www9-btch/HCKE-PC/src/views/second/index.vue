  ...
  <div class="w100 baselight nmb_ptb10 nmb_plr10">
    <div class="flex mb_alcenter mb_vh100 mb_flexdir">
      <div class="flex3 flex column h100 mb_mr10  bgwhite dark-bg-1C2532" v-if="mathid">
        <div v-if="list.length > 0 && list[currentIndex]" class="flex alcenter hidden-xs plr30 ptb10">
          <div class="ft16 pointer ht40 lh40 plr20" :class="{ 'bg-main-liner white': itm.symbol == currentSymbol }"
