...
//_HOST = "TESTus";				//本地測試用		打包部署请注释 使用上面动态获取域名
// var _DOMAIN = `https://api.${_HOST}.com`;
// _DOMAIN = window.location.origin.replace(/\/\/[a-zA-Z0-9]+\./g, "//api.");
var _DOMAIN = window.location.origin.includes('localhost')? `https://api2.${_HOST}.com`: window.location.origin.replace(/\/\/[a-zA-Z0-9]+\./g, "//api2.");
