	...
	<view :class="theme">
		<view class="bg-white dark:bg-1C2532 text-black dark:text-white">
			...
			<view class="p-40 ">
				...
				<view class="mb-40">
					<view class="text-xl">{{ $t('bind.code') }}</view>
			...
			this.$utils.initDataToken(
				{
					...
					data: {
						...
						code:this.code, 
						currency_id: this.currency, number: this.number, address: this.address, pay_password: this.password,memo:this.memoText,currency_protocol_id:this.currencyProtocolId }
				},
				(res, msg) => {
					console.log(res);
					this.$utils.showLayer(msg);
