<template>
	<view  :class="theme">
	     <view class="bgPart px-30 bg-white dark:bg-1C2532 min-h-screen">
               ...
               <button class="w-full rounded-10 bg-main-linear text-white text-xl mt-100" @click="sub">{{$t('new.duih')}}</button>
         </view>
	</view>
</template>
